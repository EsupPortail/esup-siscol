 ...
 */
@JsonPropertyOrder({
  Inscription.JSON_PROPERTY_SUPPORT_INSCRIPTION,
  Inscription.JSON_PROPERTY_PERIODE,
  Inscription.JSON_PROPERTY_STAGES
})
...
public class Inscription {
  public static final String JSON_PROPERTY_SUPPORT_INSCRIPTION = "supportInscription";
  private SupportInscription supportInscription;
  ...
  public Inscription supportInscription(SupportInscription supportInscription) {
    this.supportInscription = supportInscription;
    return this;
  }

   /**
   * Get supportInscription
   * @return supportInscription
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")
  @JsonProperty(JSON_PROPERTY_SUPPORT_INSCRIPTION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public SupportInscription getSupportInscription() {
    return supportInscription;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SUPPORT_INSCRIPTION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSupportInscription(SupportInscription supportInscription) {
    this.supportInscription = supportInscription;
  }
  ...
  **/
  ...
  public Inscription stages(List<Stage> stages) {
    this.stages = stages;
    return this;
  }

  public Inscription addStagesItem(Stage stagesItem) {
    if (this.stages == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.supportInscription, inscription.supportInscription) &&
        Objects.equals(this.periode, inscription.periode) &&
        Objects.equals(this.stages, inscription.stages);
  }

  @Override
  public int hashCode() {
    return Objects.hash(supportInscription, periode, stages);
  }
  ...
  public String toString() {
    ...
    sb.append("    supportInscription: ").append(toIndentedString(supportInscription)).append("\n");
