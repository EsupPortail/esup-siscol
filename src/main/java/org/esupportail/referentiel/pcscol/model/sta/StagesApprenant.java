 ...
 */
@JsonPropertyOrder({
  StagesApprenant.JSON_PROPERTY_CODE_STRUCTURE,
  StagesApprenant.JSON_PROPERTY_APPRENANT,
  StagesApprenant.JSON_PROPERTY_INSCRIPTIONS
})
...
public class StagesApprenant {
  ...
  public StagesApprenant() { 
  }

  public StagesApprenant codeStructure(String codeStructure) {
    this.codeStructure = codeStructure;
    return this;
  }

   /**
   * Le code de l&#39;établissement Pegase
   * @return codeStructure
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Le code de l'établissement Pegase")
  ...
  public StagesApprenant apprenant(Apprenant apprenant) {
  ...
  **/
  ...
  public StagesApprenant inscriptions(List<Inscription> inscriptions) {
    this.inscriptions = inscriptions;
    return this;
  }

  public StagesApprenant addInscriptionsItem(Inscription inscriptionsItem) {
  ...
  **/
  ...
  /**
   * Return true if this StagesApprenant object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    StagesApprenant stagesApprenant = (StagesApprenant) o;
    return Objects.equals(this.codeStructure, stagesApprenant.codeStructure) &&
        Objects.equals(this.apprenant, stagesApprenant.apprenant) &&
        Objects.equals(this.inscriptions, stagesApprenant.inscriptions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(codeStructure, apprenant, inscriptions);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StagesApprenant {\n");
