...
public class PremieresInscriptions {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getAnneeEnseignementSuperieur() != null) {
      joiner.add(String.format("%sanneeEnseignementSuperieur%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAnneeEnseignementSuperieur()))));
    }

    // add `anneeUniversite` to the URL query string
    if (getAnneeUniversite() != null) {
      joiner.add(String.format("%sanneeUniversite%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAnneeUniversite()))));
    }

    // add `anneeEtablissement` to the URL query string
    if (getAnneeEtablissement() != null) {
      joiner.add(String.format("%sanneeEtablissement%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getAnneeEtablissement()))));
    }
