...
public class Formation extends ObjetAvecLibelle {
  ...
  @Override
  public Formation est1(@jakarta.annotation.Nonnull String est1) {
    this.setEst1(est1);
    return this;
  }

  @Override
  public Formation code(@jakarta.annotation.Nullable String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public Formation libelleCourt(@jakarta.annotation.Nullable String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public Formation libelleLong(@jakarta.annotation.Nullable String libelleLong) {
