...
public class Calendrier extends ObjetAvecDates {
  ...
  public Calendrier contexte(List<ContexteInscription> contexte) {
  ...
  @JsonProperty(JSON_PROPERTY_CONTEXTE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setContexte(List<ContexteInscription> contexte) {
    this.contexte = contexte;
  }


  public Calendrier temoinActif(Boolean temoinActif) {
  ...
  @JsonProperty(JSON_PROPERTY_TEMOIN_ACTIF)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTemoinActif(Boolean temoinActif) {
    this.temoinActif = temoinActif;
  }
  ...
  public String toUrlQueryString(String prefix) {
      ...
      for (int i = 0; i < getContexte().size(); i++) {
        if (getContexte().get(i) != null) {
          joiner.add(String.format("%scontexte%s%s=%s", prefix, suffix,
              ...
              URLEncoder.encode(ApiClient.valueToString(getContexte().get(i)), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
        }
      }
    }
    ...
    if (getTemoinActif() != null) {
      joiner.add(String.format("%stemoinActif%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getTemoinActif()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
