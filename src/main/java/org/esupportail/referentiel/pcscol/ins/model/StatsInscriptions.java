...
public class StatsInscriptions {
  ...
  public StatsInscriptions validees(@jakarta.annotation.Nonnull Integer validees) {
  ...
  @JsonProperty(JSON_PROPERTY_VALIDEES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setValidees(@jakarta.annotation.Nonnull Integer validees) {
    this.validees = validees;
  }


  /**
   * Return true if this StatsInscriptions object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `validees` to the URL query string
    if (getValidees() != null) {
      joiner.add(String.format("%svalidees%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getValidees()))));
    }
