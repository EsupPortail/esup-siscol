...
public class MetaDonnee {
  ...
  public MetaDonnee contexteInscription(@jakarta.annotation.Nullable ContexteInscription contexteInscription) {
  ...
  public MetaDonnee temoinNeoBachelier(@jakarta.annotation.Nullable Boolean temoinNeoBachelier) {
  ...
  public MetaDonnee codeStructure(@jakarta.annotation.Nonnull String codeStructure) {
  ...
  public MetaDonnee codeApprenant(@jakarta.annotation.Nullable String codeApprenant) {
