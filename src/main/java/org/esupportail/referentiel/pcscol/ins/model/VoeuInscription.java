...
public class VoeuInscription extends VoeuBase {
  ...
  public VoeuInscription cible(@jakarta.annotation.Nullable CibleInscription cible) {
    this.cible = cible;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CIBLE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCible(@jakarta.annotation.Nullable CibleInscription cible) {
    this.cible = cible;
  }


  @Override
  public VoeuInscription est1(@jakarta.annotation.Nonnull String est1) {
    this.setEst1(est1);
    return this;
  }

  @Override
  public VoeuInscription noCandidat(@jakarta.annotation.Nullable String noCandidat) {
    this.setNoCandidat(noCandidat);
    return this;
  }

  @Override
  public VoeuInscription choisi(@jakarta.annotation.Nullable Boolean choisi) {
    this.setChoisi(choisi);
    return this;
  }

  @Override
  public VoeuInscription origine(@jakarta.annotation.Nullable Origine origine) {
    this.setOrigine(origine);
    return this;
  }

  @Override
  public VoeuInscription statutInscription(@jakarta.annotation.Nullable StatutInscriptionVoeu statutInscription) {
    this.setStatutInscription(statutInscription);
    return this;
  }

  @Override
  public VoeuInscription statutPaiement(@jakarta.annotation.Nullable StatutPaiementVoeu statutPaiement) {
    this.setStatutPaiement(statutPaiement);
    return this;
  }

  @Override
  public VoeuInscription codeRegimeInscription(@jakarta.annotation.Nullable String codeRegimeInscription) {
    this.setCodeRegimeInscription(codeRegimeInscription);
    return this;
  }

  @Override
  public VoeuInscription boursesEtAides(@jakarta.annotation.Nullable List<String> boursesEtAides) {
    this.setBoursesEtAides(boursesEtAides);
    return this;
  }

  @Override
  public VoeuInscription motifAnnulation(@jakarta.annotation.Nullable MotifAnnulation motifAnnulation) {
