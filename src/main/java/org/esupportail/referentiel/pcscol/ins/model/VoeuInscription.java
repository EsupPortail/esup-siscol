 ...
 */
@JsonPropertyOrder({
  VoeuInscription.JSON_PROPERTY_CIBLE
})
...
public class VoeuInscription extends VoeuBase {
  ...
  @Override
  public VoeuInscription est1(String est1) {
    this.setEst1(est1);
    return this;
  }

  @Override
  public VoeuInscription noCandidat(String noCandidat) {
    this.setNoCandidat(noCandidat);
    return this;
  }

  @Override
  public VoeuInscription choisi(Boolean choisi) {
    this.setChoisi(choisi);
    return this;
  }

  @Override
  public VoeuInscription origine(Origine origine) {
    this.setOrigine(origine);
    return this;
  }

  @Override
  public VoeuInscription statutInscription(StatutInscriptionVoeu statutInscription) {
    this.setStatutInscription(statutInscription);
    return this;
  }

  @Override
  public VoeuInscription statutPaiement(StatutPaiementVoeu statutPaiement) {
    this.setStatutPaiement(statutPaiement);
    return this;
  }

  @Override
  public VoeuInscription statutPieces(StatutPiecesVoeu statutPieces) {
    this.setStatutPieces(statutPieces);
    return this;
  }

  @Override
  public VoeuInscription codeRegimeInscription(String codeRegimeInscription) {
    this.setCodeRegimeInscription(codeRegimeInscription);
    return this;
  }

  @Override
  public VoeuInscription boursesEtAides(List<String> boursesEtAides) {
    this.setBoursesEtAides(boursesEtAides);
    return this;
  }

  @Override
  public VoeuInscription motifAnnulation(MotifAnnulation motifAnnulation) {
    this.setMotifAnnulation(motifAnnulation);
    return this;
  }

  /**
   * Return true if this VoeuInscription object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(VoeuInscription.class, "est1", mappings);
}
}
