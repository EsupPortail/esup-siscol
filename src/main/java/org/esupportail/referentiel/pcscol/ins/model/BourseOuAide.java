...
public class BourseOuAide extends Nomenclature {
  ...
  @Override
  public BourseOuAide typeNomenclature(String typeNomenclature) {
    this.setTypeNomenclature(typeNomenclature);
    return this;
  }

  @Override
  public BourseOuAide code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public BourseOuAide libelle(String libelle) {
    this.setLibelle(libelle);
    return this;
  }

  @Override
  public BourseOuAide prioriteAffichage(Integer prioriteAffichage) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getTemoinExonere() != null) {
      joiner.add(String.format("%stemoinExonere%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getTemoinExonere()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
