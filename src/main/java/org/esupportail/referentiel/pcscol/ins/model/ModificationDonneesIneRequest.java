...
public class ModificationDonneesIneRequest {
  ...
  public ModificationDonneesIneRequest ine(@jakarta.annotation.Nonnull String ine) {
    this.ine = ine;
    return this;
  }
  ...
  public ModificationDonneesIneRequest dateDeNaissance(@jakarta.annotation.Nonnull String dateDeNaissance) {
  ...
  public ModificationDonneesIneRequest paysDeNaissance(@jakarta.annotation.Nonnull String paysDeNaissance) {
  ...
  public ModificationDonneesIneRequest communeDeNaissance(@jakarta.annotation.Nullable String communeDeNaissance) {
  ...
  public ModificationDonneesIneRequest etatCivil(@jakarta.annotation.Nonnull EtatCivil etatCivil) {
