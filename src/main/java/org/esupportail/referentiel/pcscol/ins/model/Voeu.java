...
public class Voeu extends VoeuBase {
  ...
  @Override
  public Voeu est1(String est1) {
    this.setEst1(est1);
    return this;
  }

  @Override
  public Voeu noCandidat(String noCandidat) {
    this.setNoCandidat(noCandidat);
    return this;
  }

  @Override
  public Voeu choisi(Boolean choisi) {
    this.setChoisi(choisi);
    return this;
  }

  @Override
  public Voeu origine(Origine origine) {
    this.setOrigine(origine);
    return this;
  }

  @Override
  public Voeu statutInscription(StatutInscriptionVoeu statutInscription) {
    this.setStatutInscription(statutInscription);
    return this;
  }

  @Override
  public Voeu statutPaiement(StatutPaiementVoeu statutPaiement) {
    this.setStatutPaiement(statutPaiement);
    return this;
  }

  @Override
  public Voeu statutPieces(StatutPiecesVoeu statutPieces) {
    this.setStatutPieces(statutPieces);
    return this;
  }

  @Override
  public Voeu codeRegimeInscription(String codeRegimeInscription) {
    this.setCodeRegimeInscription(codeRegimeInscription);
    return this;
  }

  @Override
  public Voeu boursesEtAides(List<String> boursesEtAides) {
    this.setBoursesEtAides(boursesEtAides);
    return this;
  }

  @Override
  public Voeu motifAnnulation(MotifAnnulation motifAnnulation) {
