...
public class Apprenant {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getDateContexteApprenant() != null) {
      joiner.add(String.format("%sdateContexteApprenant%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getDateContexteApprenant()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
