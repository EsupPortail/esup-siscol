...
public class DatesValidation {
    ...
    public DatesValidation() {}

    public DatesValidation dateDebut(Date dateDebut) {
    ...
    public DatesValidation dateFin(Date dateFin) {
    ...
    /** Return true if this DatesValidation object is equal to o. */
    @Override
    public boolean equals(Object o) {
        ...
        DatesValidation datesValidation = (DatesValidation) o;
        return Objects.equals(this.dateDebut, datesValidation.dateDebut)
                && Objects.equals(this.dateFin, datesValidation.dateFin);
    }
    ...
    public String toString() {
        ...
        sb.append("class DatesValidation {\n");
        ...
        if (getDateDebut() != null) {
            joiner.add(
                    String.format(
                            ...
                            suffix,
                            URLEncoder.encode(
                                            ApiClient.valueToString(getDateDebut()),
        ...
        if (getDateFin() != null) {
            joiner.add(
                    String.format(
                            ...
                            suffix,
                            URLEncoder.encode(
                                            ApiClient.valueToString(getDateFin()),
                                            StandardCharsets.UTF_8)
                                    .replaceAll("\\+", "%20")));
        }
