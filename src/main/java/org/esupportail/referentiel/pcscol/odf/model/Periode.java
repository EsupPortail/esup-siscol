...
@JsonPropertyOrder({
    ...
    Periode.JSON_PROPERTY_VALIDITE,
...
@JsonTypeInfo(
        ...
        property = "typeEspace",
        visible = true)
public class Periode extends Espace {
    ...
    public Periode validite(DatesValidation validite) {
    ...
    public Periode type(Typologie type) {
        this.type = type;
        return this;
    }
    ...
    @Override
    public Periode typeEspace(TypeEspace typeEspace) {
    ...
    static {
        ...
        JSON.registerDiscriminator(Periode.class, "typeEspace", mappings);
    }
}
