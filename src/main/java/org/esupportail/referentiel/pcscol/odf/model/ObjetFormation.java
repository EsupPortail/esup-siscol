...
@JsonTypeInfo(
        ...
        visible = true)
public class ObjetFormation extends ObjetMaquetteDetail {
    public ObjetFormation() {}

    @Override
    public ObjetFormation id(UUID id) {
        this.setId(id);
        return this;
    }

    @Override
    public ObjetFormation typeObjetMaquette(TypeObjetMaquette typeObjetMaquette) {
    ...
    @Override
    public ObjetFormation espace(UUID espace) {
    ...
    @Override
    public ObjetFormation enfants(List<Enfant> enfants) {
        this.setEnfants(enfants);
        return this;
    }

    @Override
    public ObjetFormation contextes(List<Contexte> contextes) {
        this.setContextes(contextes);
        return this;
    }

    @Override
    public ObjetFormation descripteursObjetMaquette(
    ...
    @Override
    public ObjetFormation descripteursEnquete(DescripteursEnquete descripteursEnquete) {
        this.setDescripteursEnquete(descripteursEnquete);
        return this;
    }

    @Override
    public ObjetFormation descripteursSyllabus(DescripteursSyllabus descripteursSyllabus) {
        this.setDescripteursSyllabus(descripteursSyllabus);
        return this;
    }

    @Override
    public ObjetFormation formatsEnseignement(FormatsEnseignement formatsEnseignement) {
    ...
    static {
        ...
        JSON.registerDiscriminator(ObjetFormation.class, "typeObjetMaquette", mappings);
    }
}
