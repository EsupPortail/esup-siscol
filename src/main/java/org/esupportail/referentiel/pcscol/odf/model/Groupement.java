...
@JsonTypeInfo(
        ...
        visible = true)
public class Groupement extends ObjetMaquetteDetail {
    public Groupement() {}

    @Override
    public Groupement id(UUID id) {
        this.setId(id);
        return this;
    }

    @Override
    public Groupement typeObjetMaquette(TypeObjetMaquette typeObjetMaquette) {
    ...
    @Override
    public Groupement espace(UUID espace) {
    ...
    @Override
    public Groupement enfants(List<Enfant> enfants) {
        this.setEnfants(enfants);
        return this;
    }

    @Override
    public Groupement contextes(List<Contexte> contextes) {
        this.setContextes(contextes);
        return this;
    }

    @Override
    public Groupement descripteursObjetMaquette(
    ...
    @Override
    public Groupement descripteursEnquete(DescripteursEnquete descripteursEnquete) {
        this.setDescripteursEnquete(descripteursEnquete);
        return this;
    }

    @Override
    public Groupement descripteursSyllabus(DescripteursSyllabus descripteursSyllabus) {
        this.setDescripteursSyllabus(descripteursSyllabus);
        return this;
    }

    @Override
    public Groupement formatsEnseignement(FormatsEnseignement formatsEnseignement) {
    ...
    static {
        ...
        JSON.registerDiscriminator(Groupement.class, "typeObjetMaquette", mappings);
    }
}
