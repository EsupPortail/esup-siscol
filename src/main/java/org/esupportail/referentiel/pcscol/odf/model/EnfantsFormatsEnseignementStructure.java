...
public class EnfantsFormatsEnseignementStructure {
    public static final String JSON_PROPERTY_OBJET_MAQUETTE = "objetMaquette";
    private ObjetMaquetteFormatsEnseignementStructure objetMaquette;

    public EnfantsFormatsEnseignementStructure() {}

    public EnfantsFormatsEnseignementStructure objetMaquette(
            ObjetMaquetteFormatsEnseignementStructure objetMaquette) {
    ...
    @JsonProperty(JSON_PROPERTY_OBJET_MAQUETTE)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    public void setObjetMaquette(ObjetMaquetteFormatsEnseignementStructure objetMaquette) {
        this.objetMaquette = objetMaquette;
    }

    /** Return true if this EnfantsFormatsEnseignementStructure object is equal to o. */
    @Override
    public boolean equals(Object o) {
        ...
        EnfantsFormatsEnseignementStructure enfantsFormatsEnseignementStructure =
                (EnfantsFormatsEnseignementStructure) o;
        return Objects.equals(
                this.objetMaquette, enfantsFormatsEnseignementStructure.objetMaquette);
    }

    @Override
    public int hashCode() {
        return Objects.hash(objetMaquette);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class EnfantsFormatsEnseignementStructure {\n");
