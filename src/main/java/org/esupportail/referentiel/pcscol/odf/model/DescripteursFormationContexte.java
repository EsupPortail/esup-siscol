...
@JsonTypeInfo(
        ...
        visible = true)
public class DescripteursFormationContexte extends DescripteursContexte {
    public DescripteursFormationContexte() {}

    @Override
    public DescripteursFormationContexte typeObjetMaquette(TypeObjetMaquette typeObjetMaquette) {
        this.setTypeObjetMaquette(typeObjetMaquette);
        return this;
    }

    /** Return true if this DescripteursFormationContexte object is equal to o. */
    @Override
    ...
    public String toString() {
        ...
        sb.append("class DescripteursFormationContexte {\n");
    ...
    static {
        ...
        mappings.put("DescripteursFormationContexte", DescripteursFormationContexte.class);
        JSON.registerDiscriminator(
                DescripteursFormationContexte.class, "typeObjetMaquette", mappings);
    }
}
