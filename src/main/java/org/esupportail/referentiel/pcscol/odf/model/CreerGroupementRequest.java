...
@JsonTypeInfo(
        ...
        visible = true)
public class CreerGroupementRequest extends CreerObjetMaquetteRequest {
    public CreerGroupementRequest() {}

    @Override
    public CreerGroupementRequest espaceId(UUID espaceId) {
        this.setEspaceId(espaceId);
        return this;
    }

    @Override
    public CreerGroupementRequest typeObjetMaquette(TypeObjetMaquette typeObjetMaquette) {
        this.setTypeObjetMaquette(typeObjetMaquette);
        return this;
    }

    @Override
    public CreerGroupementRequest code(String code) {
        this.setCode(code);
        return this;
    }

    @Override
    public CreerGroupementRequest mutualise(Boolean mutualise) {
        this.setMutualise(mutualise);
        return this;
    }

    @Override
    public CreerGroupementRequest descripteursObjetMaquette(
            DescripteursObjetMaquetteRequest descripteursObjetMaquette) {
        this.setDescripteursObjetMaquette(descripteursObjetMaquette);
        return this;
    }

    /** Return true if this CreerGroupementRequest object is equal to o. */
    @Override
    ...
    public String toString() {
        ...
        sb.append("class CreerGroupementRequest {\n");
    ...
    static {
        ...
        mappings.put("CreerGroupementRequest", CreerGroupementRequest.class);
        JSON.registerDiscriminator(CreerGroupementRequest.class, "typeObjetMaquette", mappings);
    }
}
