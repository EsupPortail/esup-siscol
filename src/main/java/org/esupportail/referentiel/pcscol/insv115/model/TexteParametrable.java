...
public class TexteParametrable {
  ...
  public TexteParametrable codeStructure(@jakarta.annotation.Nonnull String codeStructure) {
  ...
  public TexteParametrable typeTexte(@jakarta.annotation.Nonnull TypeTexte typeTexte) {
  ...
  @JsonProperty(JSON_PROPERTY_TYPE_TEXTE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setTypeTexte(@jakarta.annotation.Nonnull TypeTexte typeTexte) {
    this.typeTexte = typeTexte;
  }


  public TexteParametrable contenu(@jakarta.annotation.Nonnull String contenu) {
