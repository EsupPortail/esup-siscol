 ...
 */
@JsonPropertyOrder({
  ObjetLibellePourExtraction.JSON_PROPERTY_CODE,
  ObjetLibellePourExtraction.JSON_PROPERTY_LIBELLE_COURT,
  ObjetLibellePourExtraction.JSON_PROPERTY_LIBELLE_LONG
})
...
public class ObjetLibellePourExtraction {
  ...
  /**
   * Return true if this ObjetLibellePourExtraction object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.code, objetLibellePourExtraction.code) &&
        equalsNullable(this.libelleCourt, objetLibellePourExtraction.libelleCourt) &&
        equalsNullable(this.libelleLong, objetLibellePourExtraction.libelleLong);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(code), hashCodeNullable(libelleCourt), hashCodeNullable(libelleLong));
  }
