 ...
 */
@JsonPropertyOrder({
  ApprenantPourext.JSON_PROPERTY_CODE_APPRENANT,
  ApprenantPourext.JSON_PROPERTY_NOM_FAMILLE,
  ApprenantPourext.JSON_PROPERTY_PRENOM,
  ApprenantPourext.JSON_PROPERTY_DATE_NAISSANCE,
  ApprenantPourext.JSON_PROPERTY_AMENAGEMENTS
})
...
public class ApprenantPourext {
  ...
  /**
   * Return true if this ApprenantPourext object is equal to o.
   */
  @Override
