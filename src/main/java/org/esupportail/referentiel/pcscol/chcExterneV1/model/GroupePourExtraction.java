 ...
 */
@JsonPropertyOrder({
  GroupePourExtraction.JSON_PROPERTY_CODE,
  GroupePourExtraction.JSON_PROPERTY_LIBELLE_COURT,
  GroupePourExtraction.JSON_PROPERTY_LIBELLE_LONG,
  GroupePourExtraction.JSON_PROPERTY_TYPE,
  GroupePourExtraction.JSON_PROPERTY_CAPACITE,
  GroupePourExtraction.JSON_PROPERTY_PLACES_RESERVEES,
  GroupePourExtraction.JSON_PROPERTY_PLANIFIABLE
})
...
public class GroupePourExtraction {
  ...
  private JsonNullable<Integer> capacite = JsonNullable.<Integer>undefined();

  public static final String JSON_PROPERTY_PLACES_RESERVEES = "placesReservees";
  private JsonNullable<Integer> placesReservees = JsonNullable.<Integer>undefined();
  ...
  public GroupePourExtraction capacite(@jakarta.annotation.Nullable Integer capacite) {
    this.capacite = JsonNullable.<Integer>of(capacite);
    return this;
  }
  ...
  public JsonNullable<Integer> getCapacite_JsonNullable() {
    return capacite;
  }
  
  @JsonProperty(JSON_PROPERTY_CAPACITE)
  public void setCapacite_JsonNullable(JsonNullable<Integer> capacite) {
  ...
  public GroupePourExtraction placesReservees(@jakarta.annotation.Nullable Integer placesReservees) {
    this.placesReservees = JsonNullable.<Integer>of(placesReservees);
    return this;
  }
  ...
  public Integer getPlacesReservees() {
        return placesReservees.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_PLACES_RESERVEES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<Integer> getPlacesReservees_JsonNullable() {
    return placesReservees;
  }
  
  @JsonProperty(JSON_PROPERTY_PLACES_RESERVEES)
  public void setPlacesReservees_JsonNullable(JsonNullable<Integer> placesReservees) {
  ...
  /**
   * Return true if this GroupePourExtraction object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, groupePourExtraction.code) &&
        ...
        equalsNullable(this.capacite, groupePourExtraction.capacite) &&
        equalsNullable(this.placesReservees, groupePourExtraction.placesReservees) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, libelleCourt, libelleLong, type, hashCodeNullable(capacite), hashCodeNullable(placesReservees), planifiable);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getCapacite() != null) {
      joiner.add(String.format("%scapacite%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getCapacite()))));
    }

    // add `placesReservees` to the URL query string
    if (getPlacesReservees() != null) {
      joiner.add(String.format("%splacesReservees%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPlacesReservees()))));
    }
