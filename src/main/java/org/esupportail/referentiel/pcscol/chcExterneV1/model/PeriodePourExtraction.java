 ...
 */
@JsonPropertyOrder({
  PeriodePourExtraction.JSON_PROPERTY_CODE,
  PeriodePourExtraction.JSON_PROPERTY_LIBELLE_COURT,
  PeriodePourExtraction.JSON_PROPERTY_LIBELLE_LONG,
  PeriodePourExtraction.JSON_PROPERTY_DATE_DEBUT,
  PeriodePourExtraction.JSON_PROPERTY_DATE_FIN
})
...
public class PeriodePourExtraction {
  ...
  /**
   * Return true if this PeriodePourExtraction object is equal to o.
   */
  @Override
