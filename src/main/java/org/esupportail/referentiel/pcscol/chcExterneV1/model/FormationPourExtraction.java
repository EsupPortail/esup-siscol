 ...
 */
@JsonPropertyOrder({
  FormationPourExtraction.JSON_PROPERTY_CODE,
  FormationPourExtraction.JSON_PROPERTY_LIBELLE_COURT,
  FormationPourExtraction.JSON_PROPERTY_LIBELLE_LONG
})
...
public class FormationPourExtraction {
  ...
  /**
   * Return true if this FormationPourExtraction object is equal to o.
   */
  @Override
