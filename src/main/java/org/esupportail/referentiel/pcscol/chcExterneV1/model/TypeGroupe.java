 ...
 */
@JsonPropertyOrder({
  TypeGroupe.JSON_PROPERTY_CODE,
  TypeGroupe.JSON_PROPERTY_LIBELLE_COURT,
  TypeGroupe.JSON_PROPERTY_LIBELLE_LONG
})
...
public class TypeGroupe {
  ...
  /**
   * Return true if this TypeGroupe object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, typeGroupe.code) &&
        equalsNullable(this.libelleCourt, typeGroupe.libelleCourt) &&
        equalsNullable(this.libelleLong, typeGroupe.libelleLong);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, hashCodeNullable(libelleCourt), hashCodeNullable(libelleLong));
  }
