 ...
 */
@JsonPropertyOrder({
  TypeAmenagement.JSON_PROPERTY_CODE,
  TypeAmenagement.JSON_PROPERTY_LIBELLE_AFFICHAGE,
...
public class TypeAmenagement {
  ...
  private JsonNullable<String> libelleAffichage = JsonNullable.<String>undefined();

  public static final String JSON_PROPERTY_MOTIF = "motif";
  private JsonNullable<String> motif = JsonNullable.<String>undefined();
  ...
  public TypeAmenagement libelleAffichage(@jakarta.annotation.Nullable String libelleAffichage) {
    this.libelleAffichage = JsonNullable.<String>of(libelleAffichage);
    return this;
  }
  ...
  public String getLibelleAffichage() {
        return libelleAffichage.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_LIBELLE_AFFICHAGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<String> getLibelleAffichage_JsonNullable() {
    return libelleAffichage;
  }
  
  @JsonProperty(JSON_PROPERTY_LIBELLE_AFFICHAGE)
  public void setLibelleAffichage_JsonNullable(JsonNullable<String> libelleAffichage) {
  ...
  public TypeAmenagement motif(@jakarta.annotation.Nullable String motif) {
    this.motif = JsonNullable.<String>of(motif);
    return this;
  }
  ...
  public String getMotif() {
        return motif.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_MOTIF)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<String> getMotif_JsonNullable() {
    return motif;
  }
  
  @JsonProperty(JSON_PROPERTY_MOTIF)
  public void setMotif_JsonNullable(JsonNullable<String> motif) {
    this.motif = motif;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, typeAmenagement.code) &&
        equalsNullable(this.libelleAffichage, typeAmenagement.libelleAffichage) &&
        equalsNullable(this.motif, typeAmenagement.motif) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, hashCodeNullable(libelleAffichage), hashCodeNullable(motif), priseEnCompte);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getMotif() != null) {
      joiner.add(String.format("%smotif%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getMotif()))));
    }

    // add `priseEnCompte` to the URL query string
    if (getPriseEnCompte() != null) {
      joiner.add(String.format("%spriseEnCompte%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getPriseEnCompte()))));
    }
