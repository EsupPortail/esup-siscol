 ...
 */
@JsonPropertyOrder({
  FormationAssociee.JSON_PROPERTY_CODE,
  FormationAssociee.JSON_PROPERTY_LIBELLE_COURT,
  FormationAssociee.JSON_PROPERTY_LIBELLE_LONG
})
...
public class FormationAssociee {
  ...
  /**
   * Return true if this FormationAssociee object is equal to o.
   */
  @Override
