...
public class InfoBrouillon {
  ...
  public static final String JSON_PROPERTY_EST_UTILISATEUR_PROPRIETAIRE_BROUILLON = "estUtilisateurProprietaireBrouillon";
  ...
  /**
   * Return true if this InfoBrouillon object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `estBrouillonExistant` to the URL query string
    if (getEstBrouillonExistant() != null) {
      joiner.add(String.format("%sestBrouillonExistant%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getEstBrouillonExistant()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `estUtilisateurProprietaireBrouillon` to the URL query string
    if (getEstUtilisateurProprietaireBrouillon() != null) {
      joiner.add(String.format("%sestUtilisateurProprietaireBrouillon%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getEstUtilisateurProprietaireBrouillon()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
