 ...
 */
@JsonPropertyOrder({
  FormationCompositionDetails.JSON_PROPERTY_FORMATION_UUID,
  FormationCompositionDetails.JSON_PROPERTY_CODE,
  FormationCompositionDetails.JSON_PROPERTY_LIBELLE_COURT,
...
public class FormationCompositionDetails {
  ...
  /**
   * Return true if this FormationCompositionDetails object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `formationUuid` to the URL query string
    if (getFormationUuid() != null) {
      joiner.add(String.format("%sformationUuid%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getFormationUuid()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
