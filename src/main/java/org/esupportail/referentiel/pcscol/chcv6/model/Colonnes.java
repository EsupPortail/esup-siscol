 ...
 */
@JsonPropertyOrder({
  Colonnes.JSON_PROPERTY_AFFICHER_INE,
  Colonnes.JSON_PROPERTY_AFFICHER_CODE_APPRENANT,
  Colonnes.JSON_PROPERTY_AFFICHER_NOM,
...
public class Colonnes {
  ...
  public static final String JSON_PROPERTY_AFFICHER_CODE_APPRENANT = "afficherCodeApprenant";
  private Boolean afficherCodeApprenant = false;

  public static final String JSON_PROPERTY_AFFICHER_NOM = "afficherNom";
  private Boolean afficherNom = true;

  public static final String JSON_PROPERTY_AFFICHER_PRENOM = "afficherPrenom";
  private Boolean afficherPrenom = true;

  public static final String JSON_PROPERTY_AFFICHER_DATE_NAISSANCE = "afficherDateNaissance";
  ...
  /**
   * Return true if this Colonnes object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `afficherIne` to the URL query string
    if (getAfficherIne() != null) {
      joiner.add(String.format("%safficherIne%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAfficherIne()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `afficherCodeApprenant` to the URL query string
    if (getAfficherCodeApprenant() != null) {
      joiner.add(String.format("%safficherCodeApprenant%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAfficherCodeApprenant()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `afficherNom` to the URL query string
    if (getAfficherNom() != null) {
      joiner.add(String.format("%safficherNom%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAfficherNom()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `afficherPrenom` to the URL query string
    if (getAfficherPrenom() != null) {
      joiner.add(String.format("%safficherPrenom%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAfficherPrenom()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `afficherDateNaissance` to the URL query string
    if (getAfficherDateNaissance() != null) {
      joiner.add(String.format("%safficherDateNaissance%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAfficherDateNaissance()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
