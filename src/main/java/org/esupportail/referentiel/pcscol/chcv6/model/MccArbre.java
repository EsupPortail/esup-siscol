 ...
 */
@JsonPropertyOrder({
  MccArbre.JSON_PROPERTY_NOTE_ATTENDUE,
  MccArbre.JSON_PROPERTY_RESULTAT_ATTENDU,
  MccArbre.JSON_PROPERTY_SESSION_DOUBLE,
...
public class MccArbre {
  ...
  public static final String JSON_PROPERTY_RESULTAT_ATTENDU = "resultatAttendu";
  private Boolean resultatAttendu;

  public static final String JSON_PROPERTY_SESSION_DOUBLE = "sessionDouble";
  private Boolean sessionDouble;

  public static final String JSON_PROPERTY_REGLE_CALCUL_NOTE = "regleCalculNote";
  private Boolean regleCalculNote;

  public static final String JSON_PROPERTY_REGLE_CALCUL_RESULTAT = "regleCalculResultat";
  private Boolean regleCalculResultat;

  public MccArbre() { 
  }

  public MccArbre noteAttendue(Boolean noteAttendue) {
  ...
  @JsonProperty(JSON_PROPERTY_NOTE_ATTENDUE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNoteAttendue(Boolean noteAttendue) {
    this.noteAttendue = noteAttendue;
  }


  public MccArbre resultatAttendu(Boolean resultatAttendu) {
  ...
  public MccArbre sessionDouble(Boolean sessionDouble) {
    this.sessionDouble = sessionDouble;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SESSION_DOUBLE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSessionDouble(Boolean sessionDouble) {
    this.sessionDouble = sessionDouble;
  }


  public MccArbre regleCalculNote(Boolean regleCalculNote) {
    this.regleCalculNote = regleCalculNote;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_REGLE_CALCUL_NOTE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRegleCalculNote(Boolean regleCalculNote) {
    this.regleCalculNote = regleCalculNote;
  }


  public MccArbre regleCalculResultat(Boolean regleCalculResultat) {
    this.regleCalculResultat = regleCalculResultat;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_REGLE_CALCUL_RESULTAT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRegleCalculResultat(Boolean regleCalculResultat) {
    this.regleCalculResultat = regleCalculResultat;
  }


  /**
   * Return true if this MccArbre object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MccArbre mccArbre = (MccArbre) o;
    return Objects.equals(this.noteAttendue, mccArbre.noteAttendue) &&
        Objects.equals(this.resultatAttendu, mccArbre.resultatAttendu) &&
        Objects.equals(this.sessionDouble, mccArbre.sessionDouble) &&
        Objects.equals(this.regleCalculNote, mccArbre.regleCalculNote) &&
        Objects.equals(this.regleCalculResultat, mccArbre.regleCalculResultat);
  }

  @Override
  public int hashCode() {
    return Objects.hash(noteAttendue, resultatAttendu, sessionDouble, regleCalculNote, regleCalculResultat);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MccArbre {\n");
    sb.append("    noteAttendue: ").append(toIndentedString(noteAttendue)).append("\n");
    sb.append("    resultatAttendu: ").append(toIndentedString(resultatAttendu)).append("\n");
    sb.append("    sessionDouble: ").append(toIndentedString(sessionDouble)).append("\n");
    sb.append("    regleCalculNote: ").append(toIndentedString(regleCalculNote)).append("\n");
    sb.append("    regleCalculResultat: ").append(toIndentedString(regleCalculResultat)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `noteAttendue` to the URL query string
    if (getNoteAttendue() != null) {
      joiner.add(String.format("%snoteAttendue%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getNoteAttendue()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `resultatAttendu` to the URL query string
    if (getResultatAttendu() != null) {
      joiner.add(String.format("%sresultatAttendu%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getResultatAttendu()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `sessionDouble` to the URL query string
    if (getSessionDouble() != null) {
      joiner.add(String.format("%ssessionDouble%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getSessionDouble()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `regleCalculNote` to the URL query string
    if (getRegleCalculNote() != null) {
      joiner.add(String.format("%sregleCalculNote%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getRegleCalculNote()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `regleCalculResultat` to the URL query string
    if (getRegleCalculResultat() != null) {
      joiner.add(String.format("%sregleCalculResultat%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getRegleCalculResultat()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
