...
/**
 * ChoixPedagogiqueEnMasseOperation
 */
@JsonPropertyOrder({
...
public class ChoixPedagogiqueEnMasseOperation {
  ...
  public enum CommandeEnum {
    CHOISIR_AFFECTATION_("CHOISIR_AFFECTATION,"),
    
    CHOISIR_CAPITALISATION_("CHOISIR_CAPITALISATION,"),
    
    ANNULER_CHOIX_AFFECTATION_("ANNULER_CHOIX_AFFECTATION,"),
    
    ANNULER_CHOIX_CAPITALISATION_("ANNULER_CHOIX_CAPITALISATION,");

    private String value;

    CommandeEnum(String value) {
      this.value = value;
    }
    ...
    @JsonCreator
    public static CommandeEnum fromValue(String value) {
      for (CommandeEnum b : CommandeEnum.values()) {
  ...
  public ChoixPedagogiqueEnMasseOperation() { 
  }

  public ChoixPedagogiqueEnMasseOperation commande(CommandeEnum commande) {
  ...
  @JsonProperty(JSON_PROPERTY_COMMANDE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCommande(CommandeEnum commande) {
    this.commande = commande;
  }


  public ChoixPedagogiqueEnMasseOperation cursusUuid(UUID cursusUuid) {
  ...
  /**
   * Return true if this ChoixPedagogiqueEnMasseOperation object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ChoixPedagogiqueEnMasseOperation choixPedagogiqueEnMasseOperation = (ChoixPedagogiqueEnMasseOperation) o;
    return Objects.equals(this.commande, choixPedagogiqueEnMasseOperation.commande) &&
        Objects.equals(this.cursusUuid, choixPedagogiqueEnMasseOperation.cursusUuid);
  }

  @Override
  public int hashCode() {
    return Objects.hash(commande, cursusUuid);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ChoixPedagogiqueEnMasseOperation {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `commande` to the URL query string
    if (getCommande() != null) {
      joiner.add(String.format("%scommande%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCommande()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
