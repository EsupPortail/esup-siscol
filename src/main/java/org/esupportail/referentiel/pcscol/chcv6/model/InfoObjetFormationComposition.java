 ...
 */
@JsonPropertyOrder({
  InfoObjetFormationComposition.JSON_PROPERTY_CODE,
  InfoObjetFormationComposition.JSON_PROPERTY_LIBELLE,
...
public class InfoObjetFormationComposition {
  ...
  /**
   * Return true if this InfoObjetFormationComposition object is equal to o.
   */
  @Override
