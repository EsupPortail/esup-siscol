 ...
 */
@JsonPropertyOrder({
  OperationAffecterDesaffecter.JSON_PROPERTY_OP,
...
public class OperationAffecterDesaffecter {
  ...
  public static final String JSON_PROPERTY_UUID_APPRENANT = "uuidApprenant";
  ...
  /**
   * Return true if this OperationAffecterDesaffecter object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `uuidApprenant` to the URL query string
    if (getUuidApprenant() != null) {
      joiner.add(String.format("%suuidApprenant%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getUuidApprenant()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
