 ...
 */
@JsonPropertyOrder({
  ContratEditable.JSON_PROPERTY_CURSUS_ID,
  ContratEditable.JSON_PROPERTY_APPRENANT,
...
public class ContratEditable {
  ...
  public static final String JSON_PROPERTY_DATE_CREATION = "dateCreation";
  private Date dateCreation;

  public static final String JSON_PROPERTY_DATE_DERNIERE_EDITION = "dateDerniereEdition";
  ...
  /**
   * Return true if this ContratEditable object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `cursusId` to the URL query string
    if (getCursusId() != null) {
      joiner.add(String.format("%scursusId%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCursusId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    // add `dateCreation` to the URL query string
    if (getDateCreation() != null) {
      joiner.add(String.format("%sdateCreation%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getDateCreation()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `dateDerniereEdition` to the URL query string
    if (getDateDerniereEdition() != null) {
      joiner.add(String.format("%sdateDerniereEdition%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getDateDerniereEdition()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
