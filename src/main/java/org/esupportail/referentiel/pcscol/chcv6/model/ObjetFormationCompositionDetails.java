 ...
 */
@JsonPropertyOrder({
  ObjetFormationCompositionDetails.JSON_PROPERTY_OBJET_FORMATION_UUID,
  ObjetFormationCompositionDetails.JSON_PROPERTY_CODE,
  ObjetFormationCompositionDetails.JSON_PROPERTY_LIBELLE_COURT,
...
public class ObjetFormationCompositionDetails {
  ...
  /**
   * Return true if this ObjetFormationCompositionDetails object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `objetFormationUuid` to the URL query string
    if (getObjetFormationUuid() != null) {
      joiner.add(String.format("%sobjetFormationUuid%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getObjetFormationUuid()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
