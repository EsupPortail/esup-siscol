 ...
 */
@JsonPropertyOrder({
  AffectationIndividuelleAcquisUtilisableParEvaluation.JSON_PROPERTY_CODE_CHEMIN_OBJET_FORMATION_CHOIX_PEDAGOGIQUE,
  AffectationIndividuelleAcquisUtilisableParEvaluation.JSON_PROPERTY_CODE_OBJET_FORMATION_CHOIX_PEDAGOGIQUE,
  AffectationIndividuelleAcquisUtilisableParEvaluation.JSON_PROPERTY_LIBELLE_LONG_OBJET_MAQUETTE_ACQUISITION,
  AffectationIndividuelleAcquisUtilisableParEvaluation.JSON_PROPERTY_CODE_PERIODE_ACQUISITION,
  AffectationIndividuelleAcquisUtilisableParEvaluation.JSON_PROPERTY_LIBELLE_COURT_PERIODE_ACQUISITION,
  AffectationIndividuelleAcquisUtilisableParEvaluation.JSON_PROPERTY_CODE_OBJET_FORMATION_ACQUISITION,
  AffectationIndividuelleAcquisUtilisableParEvaluation.JSON_PROPERTY_UTILISABLE_VIA_LCC,
  AffectationIndividuelleAcquisUtilisableParEvaluation.JSON_PROPERTY_NOTE_FINALE,
  AffectationIndividuelleAcquisUtilisableParEvaluation.JSON_PROPERTY_BAREME,
  AffectationIndividuelleAcquisUtilisableParEvaluation.JSON_PROPERTY_RESULTAT_FINAL_ACQUISITION_LIBELLE_LONG,
  AffectationIndividuelleAcquisUtilisableParEvaluation.JSON_PROPERTY_NUMERO_SESSION_RETENUE_ACQUISITION
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-09-26T14:04:50.284799424+02:00[Europe/Paris]", comments = "Generator version: 7.8.0")
public class AffectationIndividuelleAcquisUtilisableParEvaluation {
  public static final String JSON_PROPERTY_CODE_CHEMIN_OBJET_FORMATION_CHOIX_PEDAGOGIQUE = "codeCheminObjetFormationChoixPedagogique";
  ...
  public static final String JSON_PROPERTY_RESULTAT_FINAL_ACQUISITION_LIBELLE_LONG = "resultatFinalAcquisitionLibelleLong";
  private String resultatFinalAcquisitionLibelleLong;

  public static final String JSON_PROPERTY_NUMERO_SESSION_RETENUE_ACQUISITION = "numeroSessionRetenueAcquisition";
  ...
  @JsonProperty(JSON_PROPERTY_CODE_CHEMIN_OBJET_FORMATION_CHOIX_PEDAGOGIQUE)
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_RESULTAT_FINAL_ACQUISITION_LIBELLE_LONG)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_NUMERO_SESSION_RETENUE_ACQUISITION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  /**
   * Return true if this AffectationIndividuelleAcquisUtilisableParEvaluation object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `codeCheminObjetFormationChoixPedagogique` to the URL query string
    if (getCodeCheminObjetFormationChoixPedagogique() != null) {
      joiner.add(String.format("%scodeCheminObjetFormationChoixPedagogique%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCodeCheminObjetFormationChoixPedagogique()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    // add `resultatFinalAcquisitionLibelleLong` to the URL query string
    if (getResultatFinalAcquisitionLibelleLong() != null) {
      joiner.add(String.format("%sresultatFinalAcquisitionLibelleLong%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getResultatFinalAcquisitionLibelleLong()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `numeroSessionRetenueAcquisition` to the URL query string
    if (getNumeroSessionRetenueAcquisition() != null) {
      joiner.add(String.format("%snumeroSessionRetenueAcquisition%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getNumeroSessionRetenueAcquisition()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
