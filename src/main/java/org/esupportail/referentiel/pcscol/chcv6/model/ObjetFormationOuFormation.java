 ...
 */
@JsonPropertyOrder({
  ObjetFormationOuFormation.JSON_PROPERTY_TYPE,
  ObjetFormationOuFormation.JSON_PROPERTY_CODE,
  ObjetFormationOuFormation.JSON_PROPERTY_LIBELLE_COURT,
  ObjetFormationOuFormation.JSON_PROPERTY_LIBELLE_LONG,
  ObjetFormationOuFormation.JSON_PROPERTY_MUTUALISE
})
...
@JsonSubTypes({
  ...
  @JsonSubTypes.Type(value = ObjetFormation.class, name = "ObjetFormation"),
})
...
public class ObjetFormationOuFormation {
  ...
  /**
   * Return true if this ObjetFormationOuFormation object is equal to o.
   */
  @Override
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, code, libelleCourt, libelleLong, mutualise);
  }
...
static {
  ...
  mappings.put("ObjetFormation", ObjetFormation.class);
  mappings.put("ObjetFormationOuFormation", ObjetFormationOuFormation.class);
  JSON.registerDiscriminator(ObjetFormationOuFormation.class, "type", mappings);
}
}
