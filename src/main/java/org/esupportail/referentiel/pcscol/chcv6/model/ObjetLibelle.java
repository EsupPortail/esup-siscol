 ...
 */
@JsonPropertyOrder({
  ObjetLibelle.JSON_PROPERTY_CODE,
  ObjetLibelle.JSON_PROPERTY_LIBELLE_COURT,
  ObjetLibelle.JSON_PROPERTY_LIBELLE_LONG,
  ObjetLibelle.JSON_PROPERTY_LIBELLE
})
...
public class ObjetLibelle {
  ...
  /**
   * Return true if this ObjetLibelle object is equal to o.
   */
  @Override
