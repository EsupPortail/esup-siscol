...
public class ResultatTacheLongueErreur {
  ...
  public ResultatTacheLongueErreur() { 
  }

  public ResultatTacheLongueErreur identifiantAggregat(String identifiantAggregat) {
    this.identifiantAggregat = identifiantAggregat;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_IDENTIFIANT_AGGREGAT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIdentifiantAggregat(String identifiantAggregat) {
    this.identifiantAggregat = identifiantAggregat;
  }


  public ResultatTacheLongueErreur message(String message) {
  ...
  /**
   * Return true if this ResultatTacheLongueErreur object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ResultatTacheLongueErreur resultatTacheLongueErreur = (ResultatTacheLongueErreur) o;
    return Objects.equals(this.identifiantAggregat, resultatTacheLongueErreur.identifiantAggregat) &&
        Objects.equals(this.message, resultatTacheLongueErreur.message);
  }

  @Override
  public int hashCode() {
    return Objects.hash(identifiantAggregat, message);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ResultatTacheLongueErreur {\n");
    sb.append("    identifiantAggregat: ").append(toIndentedString(identifiantAggregat)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `identifiantAggregat` to the URL query string
    if (getIdentifiantAggregat() != null) {
      joiner.add(String.format("%sidentifiantAggregat%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getIdentifiantAggregat()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
