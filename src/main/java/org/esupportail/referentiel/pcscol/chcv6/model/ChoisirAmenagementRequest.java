 ...
 */
@JsonPropertyOrder({
  ChoisirAmenagementRequest.JSON_PROPERTY_CODE_CHEMIN_CHOIX_PEDAGOGIQUE,
  ChoisirAmenagementRequest.JSON_PROPERTY_TYPE_AMENAGEMENT_CODE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-09-26T14:04:50.284799424+02:00[Europe/Paris]", comments = "Generator version: 7.8.0")
public class ChoisirAmenagementRequest {
  public static final String JSON_PROPERTY_CODE_CHEMIN_CHOIX_PEDAGOGIQUE = "codeCheminChoixPedagogique";
  private String codeCheminChoixPedagogique;

  public static final String JSON_PROPERTY_TYPE_AMENAGEMENT_CODE = "typeAmenagementCode";
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_TYPE_AMENAGEMENT_CODE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  /**
   * Return true if this ChoisirAmenagementRequest object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `codeCheminChoixPedagogique` to the URL query string
    if (getCodeCheminChoixPedagogique() != null) {
      joiner.add(String.format("%scodeCheminChoixPedagogique%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCodeCheminChoixPedagogique()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `typeAmenagementCode` to the URL query string
    if (getTypeAmenagementCode() != null) {
      joiner.add(String.format("%stypeAmenagementCode%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getTypeAmenagementCode()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
