...
public class Periode {
  ...
  public static final String JSON_PROPERTY_IDENTIFIANT = "identifiant";
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `identifiant` to the URL query string
    if (getIdentifiant() != null) {
      joiner.add(String.format("%sidentifiant%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getIdentifiant()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
