 ...
 */
@JsonPropertyOrder({
  ObjetFormation.JSON_PROPERTY_CODE_NATURE,
  ObjetFormation.JSON_PROPERTY_MUTUALISE,
  ObjetFormation.JSON_PROPERTY_STAGE
})
...
public class ObjetFormation extends ObjetFormationOuFormation {
  public static final String JSON_PROPERTY_CODE_NATURE = "codeNature";
  ...
  @Override
  public ObjetFormation type(TypeEnum type) {
    this.setType(type);
    return this;
  }
  ...
  /**
   * Return true if this ObjetFormation object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `codeNature` to the URL query string
    if (getCodeNature() != null) {
      joiner.add(String.format("%scodeNature%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCodeNature()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
...
static {
  ...
  JSON.registerDiscriminator(ObjetFormation.class, "type", mappings);
}
}
