 ...
 */
@JsonPropertyOrder({
  LienCorrespondanceCalculModification.JSON_PROPERTY_CODE_OBJET_FORMATION_CIBLE,
  LienCorrespondanceCalculModification.JSON_PROPERTY_CODE_OBJET_FORMATION_SOURCE,
...
public class LienCorrespondanceCalculModification {
  ...
  /**
   * Return true if this LienCorrespondanceCalculModification object is equal to o.
   */
  @Override
