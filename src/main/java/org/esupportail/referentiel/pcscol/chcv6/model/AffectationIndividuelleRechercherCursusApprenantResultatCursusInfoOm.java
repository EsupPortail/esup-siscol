 ...
 */
@JsonPropertyOrder({
  AffectationIndividuelleRechercherCursusApprenantResultatCursusInfoOm.JSON_PROPERTY_CODE,
...
public class AffectationIndividuelleRechercherCursusApprenantResultatCursusInfoOm {
  ...
  /**
   * Return true if this AffectationIndividuelleRechercherCursusApprenantResultatCursusInfoOm object is equal to o.
   */
  @Override
