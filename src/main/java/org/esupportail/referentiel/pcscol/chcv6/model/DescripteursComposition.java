 ...
 */
@JsonPropertyOrder({
  DescripteursComposition.JSON_PROPERTY_LIBELLE_COURT,
  DescripteursComposition.JSON_PROPERTY_LIBELLE_LONG,
...
public class DescripteursComposition {
  ...
  /**
   * Return true if this DescripteursComposition object is equal to o.
   */
  @Override
