...
public class Amenagement {
  ...
  public static final String JSON_PROPERTY_LIBELLE_AMENAGEMENT = "libelleAmenagement";
  ...
  /**
   * Return true if this Amenagement object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `codeAmenagement` to the URL query string
    if (getCodeAmenagement() != null) {
      joiner.add(String.format("%scodeAmenagement%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCodeAmenagement()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `libelleAmenagement` to the URL query string
    if (getLibelleAmenagement() != null) {
      joiner.add(String.format("%slibelleAmenagement%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getLibelleAmenagement()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
