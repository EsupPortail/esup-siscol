...
public class FaireChoixPedagogiqueAvecPropositionRequest {
  ...
  /**
   * Return true if this FaireChoixPedagogiqueAvecPropositionRequest object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `avecProposition` to the URL query string
    if (getAvecProposition() != null) {
      joiner.add(String.format("%savecProposition%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAvecProposition()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
