...
public class StatsChemins {
  ...
  /**
   * Return true if this StatsChemins object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `aAffecterAUnGroupe` to the URL query string
    if (getaAffecterAUnGroupe() != null) {
      joiner.add(String.format("%saAffecterAUnGroupe%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getaAffecterAUnGroupe()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
