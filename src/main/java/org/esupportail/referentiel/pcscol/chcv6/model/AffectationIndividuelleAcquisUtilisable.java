...
public class AffectationIndividuelleAcquisUtilisable {
  ...
  public static final String JSON_PROPERTY_ACQUIS_UTILISABLE_PAR_AMENAGEMENT = "acquisUtilisableParAmenagement";
  ...
  /**
   * Return true if this AffectationIndividuelleAcquisUtilisable object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `acquisUtilisableParEvaluation` to the URL query string
    if (getAcquisUtilisableParEvaluation() != null) {
      joiner.add(getAcquisUtilisableParEvaluation().toUrlQueryString(prefix + "acquisUtilisableParEvaluation" + suffix));
    }

    // add `acquisUtilisableParAmenagement` to the URL query string
    if (getAcquisUtilisableParAmenagement() != null) {
      joiner.add(getAcquisUtilisableParAmenagement().toUrlQueryString(prefix + "acquisUtilisableParAmenagement" + suffix));
    }
