 ...
 */
@JsonPropertyOrder({
  AffectationMasseOperation.JSON_PROPERTY_COMMANDE,
...
public class AffectationMasseOperation {
  ...
  public static final String JSON_PROPERTY_AVEC_CREATION_BROUILLON = "avecCreationBrouillon";
  ...
  /**
   * Return true if this AffectationMasseOperation object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `avecCreationBrouillon` to the URL query string
    if (getAvecCreationBrouillon() != null) {
      joiner.add(String.format("%savecCreationBrouillon%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAvecCreationBrouillon()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
