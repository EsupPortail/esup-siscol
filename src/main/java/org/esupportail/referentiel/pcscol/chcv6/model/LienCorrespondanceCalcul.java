 ...
 */
@JsonPropertyOrder({
  LienCorrespondanceCalcul.JSON_PROPERTY_CODE_OBJET_FORMATION_CIBLE,
  LienCorrespondanceCalcul.JSON_PROPERTY_CODE_TYPE_CIBLE,
  LienCorrespondanceCalcul.JSON_PROPERTY_CODE_OBJET_FORMATION_SOURCE,
  LienCorrespondanceCalcul.JSON_PROPERTY_CODE_TYPE_SOURCE,
  LienCorrespondanceCalcul.JSON_PROPERTY_COMMENTAIRE,
...
public class LienCorrespondanceCalcul {
  ...
  public static final String JSON_PROPERTY_CODE_TYPE_CIBLE = "codeTypeCible";
  private String codeTypeCible;

  public static final String JSON_PROPERTY_CODE_OBJET_FORMATION_SOURCE = "codeObjetFormationSource";
  private String codeObjetFormationSource;

  public static final String JSON_PROPERTY_CODE_TYPE_SOURCE = "codeTypeSource";
  private String codeTypeSource;

  public static final String JSON_PROPERTY_COMMENTAIRE = "commentaire";
  private String commentaire;

  public static final String JSON_PROPERTY_DATE_DE_CREATION = "dateDeCreation";
  ...
  /**
   * Return true if this LienCorrespondanceCalcul object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `codeObjetFormationCible` to the URL query string
    if (getCodeObjetFormationCible() != null) {
      joiner.add(String.format("%scodeObjetFormationCible%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCodeObjetFormationCible()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `codeTypeCible` to the URL query string
    if (getCodeTypeCible() != null) {
      joiner.add(String.format("%scodeTypeCible%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCodeTypeCible()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `codeObjetFormationSource` to the URL query string
    if (getCodeObjetFormationSource() != null) {
      joiner.add(String.format("%scodeObjetFormationSource%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCodeObjetFormationSource()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `codeTypeSource` to the URL query string
    if (getCodeTypeSource() != null) {
      joiner.add(String.format("%scodeTypeSource%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCodeTypeSource()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    // add `dateDeCreation` to the URL query string
    if (getDateDeCreation() != null) {
      joiner.add(String.format("%sdateDeCreation%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getDateDeCreation()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
