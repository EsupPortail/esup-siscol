...
/**
 * AffectationMasseSurCheminRequest
 */
@JsonPropertyOrder({
...
public class AffectationMasseSurCheminRequest {
  ...
  public static final String JSON_PROPERTY_UUID_CHEMIN_PEDAGOGIQUE = "uuidCheminPedagogique";
  private String uuidCheminPedagogique;

  public AffectationMasseSurCheminRequest() { 
  }

  public AffectationMasseSurCheminRequest operation(OperationEnum operation) {
  ...
  public AffectationMasseSurCheminRequest uuidCheminPedagogique(String uuidCheminPedagogique) {
  ...
  /**
   * Return true if this AffectationMasseSurCheminRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AffectationMasseSurCheminRequest affectationMasseSurCheminRequest = (AffectationMasseSurCheminRequest) o;
    return Objects.equals(this.operation, affectationMasseSurCheminRequest.operation) &&
        Objects.equals(this.uuidCheminPedagogique, affectationMasseSurCheminRequest.uuidCheminPedagogique);
  }

  @Override
  public int hashCode() {
    return Objects.hash(operation, uuidCheminPedagogique);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AffectationMasseSurCheminRequest {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `uuidCheminPedagogique` to the URL query string
    if (getUuidCheminPedagogique() != null) {
      joiner.add(String.format("%suuidCheminPedagogique%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getUuidCheminPedagogique()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
