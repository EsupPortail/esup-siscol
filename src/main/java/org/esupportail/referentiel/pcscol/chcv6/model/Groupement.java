 ...
 */
@JsonPropertyOrder({
  Groupement.JSON_PROPERTY_CODE,
  Groupement.JSON_PROPERTY_LIBELLE_COURT,
  Groupement.JSON_PROPERTY_LIBELLE_LONG,
...
public class Groupement {
  ...
  /**
   * Return true if this Groupement object is equal to o.
   */
  @Override
