 ...
 */
@JsonPropertyOrder({
  LigneAffectationMasse.JSON_PROPERTY_ID_CURSUS,
  LigneAffectationMasse.JSON_PROPERTY_APPRENANT,
  LigneAffectationMasse.JSON_PROPERTY_INFOS_OBJET_MAQUETTE,
  LigneAffectationMasse.JSON_PROPERTY_INFOS_PEDAGOGIQUE,
  LigneAffectationMasse.JSON_PROPERTY_POSSIBILITES_PEDAGOGIQUES,
  LigneAffectationMasse.JSON_PROPERTY_BROUILLON_EN_COURS,
...
public class LigneAffectationMasse {
  ...
  public static final String JSON_PROPERTY_INFOS_PEDAGOGIQUE = "infosPedagogique";
  private InfosPedagogique infosPedagogique;

  public static final String JSON_PROPERTY_POSSIBILITES_PEDAGOGIQUES = "possibilitesPedagogiques";
  private PossibilitesPedagogiques possibilitesPedagogiques;

  public static final String JSON_PROPERTY_BROUILLON_EN_COURS = "brouillonEnCours";
  private Boolean brouillonEnCours;

  public static final String JSON_PROPERTY_CODE_CHEMIN_OM_IA = "codeCheminOmIa";
  private String codeCheminOmIa;

  public static final String JSON_PROPERTY_PROPRIETAIRE_BROUILLON = "proprietaireBrouillon";
  ...
  /**
   * Return true if this LigneAffectationMasse object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `idCursus` to the URL query string
    if (getIdCursus() != null) {
      joiner.add(String.format("%sidCursus%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getIdCursus()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    // add `infosObjetMaquette` to the URL query string
    if (getInfosObjetMaquette() != null) {
      joiner.add(getInfosObjetMaquette().toUrlQueryString(prefix + "infosObjetMaquette" + suffix));
    }

    // add `infosPedagogique` to the URL query string
    if (getInfosPedagogique() != null) {
      joiner.add(getInfosPedagogique().toUrlQueryString(prefix + "infosPedagogique" + suffix));
    }

    // add `possibilitesPedagogiques` to the URL query string
    if (getPossibilitesPedagogiques() != null) {
      joiner.add(getPossibilitesPedagogiques().toUrlQueryString(prefix + "possibilitesPedagogiques" + suffix));
    }

    // add `brouillonEnCours` to the URL query string
    if (getBrouillonEnCours() != null) {
      joiner.add(String.format("%sbrouillonEnCours%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getBrouillonEnCours()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `codeCheminOmIa` to the URL query string
    if (getCodeCheminOmIa() != null) {
      joiner.add(String.format("%scodeCheminOmIa%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getCodeCheminOmIa()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `proprietaireBrouillon` to the URL query string
    if (getProprietaireBrouillon() != null) {
      joiner.add(String.format("%sproprietaireBrouillon%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getProprietaireBrouillon()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
