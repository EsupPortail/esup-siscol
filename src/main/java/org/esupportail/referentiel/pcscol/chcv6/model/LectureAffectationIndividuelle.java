 ...
 */
@JsonPropertyOrder({
  LectureAffectationIndividuelle.JSON_PROPERTY_CURSUS_UUID,
  LectureAffectationIndividuelle.JSON_PROPERTY_EST_COMPLET,
...
public class LectureAffectationIndividuelle {
  ...
  public static final String JSON_PROPERTY_EST_COMPLET = "estComplet";
  private Boolean estComplet;

  public static final String JSON_PROPERTY_INFO_BROUILLON = "infoBrouillon";
  ...
  /**
   * Return true if this LectureAffectationIndividuelle object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `estComplet` to the URL query string
    if (getEstComplet() != null) {
      joiner.add(String.format("%sestComplet%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getEstComplet()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `infoBrouillon` to the URL query string
    if (getInfoBrouillon() != null) {
      joiner.add(getInfoBrouillon().toUrlQueryString(prefix + "infoBrouillon" + suffix));
    }
