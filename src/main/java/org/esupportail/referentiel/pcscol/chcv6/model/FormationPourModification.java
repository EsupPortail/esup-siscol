 ...
 */
@JsonPropertyOrder({
  FormationPourModification.JSON_PROPERTY_CODE,
  FormationPourModification.JSON_PROPERTY_LIBELLE_COURT,
...
public class FormationPourModification {
  ...
  /**
   * Return true if this FormationPourModification object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, formationPourModification.code) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, libelleCourt, libelleLong, periode);
  }
