...
public class ArbreLecture {
  ...
  /**
   * Return true if this ArbreLecture object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `formationArbre` to the URL query string
    if (getFormationArbre() != null) {
      joiner.add(getFormationArbre().toUrlQueryString(prefix + "formationArbre" + suffix));
    }
