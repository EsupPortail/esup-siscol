 ...
 */
@JsonPropertyOrder({
  CompositionPourListe.JSON_PROPERTY_COMPOSITION_UUID,
  CompositionPourListe.JSON_PROPERTY_CODE,
  CompositionPourListe.JSON_PROPERTY_LIBELLE,
  CompositionPourListe.JSON_PROPERTY_LIBELLE_COURT,
  CompositionPourListe.JSON_PROPERTY_LIBELLE_LONG,
...
public class CompositionPourListe {
  ...
  public static final String JSON_PROPERTY_ASSOCIEE = "associee";
  ...
  /**
   * Return true if this CompositionPourListe object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `associee` to the URL query string
    if (getAssociee() != null) {
      joiner.add(String.format("%sassociee%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAssociee()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
