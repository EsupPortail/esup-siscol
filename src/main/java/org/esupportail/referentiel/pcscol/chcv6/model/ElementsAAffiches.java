 ...
 */
@JsonPropertyOrder({
  ElementsAAffiches.JSON_PROPERTY_AFFICHER_SIGNATURE_RESPONSABLE,
...
public class ElementsAAffiches {
  ...
  public static final String JSON_PROPERTY_AFFICHER_SIGNATURE_APPRENANT = "afficherSignatureApprenant";
  ...
  /**
   * Return true if this ElementsAAffiches object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `afficherSignatureResponsable` to the URL query string
    if (getAfficherSignatureResponsable() != null) {
      joiner.add(String.format("%safficherSignatureResponsable%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAfficherSignatureResponsable()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `afficherSignatureApprenant` to the URL query string
    if (getAfficherSignatureApprenant() != null) {
      joiner.add(String.format("%safficherSignatureApprenant%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getAfficherSignatureApprenant()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `responsable` to the URL query string
    if (getResponsable() != null) {
      joiner.add(String.format("%sresponsable%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getResponsable()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
