 ...
 */
@JsonPropertyOrder({
  GroupementMasse.JSON_PROPERTY_ID,
  GroupementMasse.JSON_PROPERTY_CODE,
  GroupementMasse.JSON_PROPERTY_LIBELLE_COURT,
  GroupementMasse.JSON_PROPERTY_CODE_NATURE,
  GroupementMasse.JSON_PROPERTY_MUTUALISE
})
...
public class GroupementMasse {
  ...
  /**
   * Return true if this GroupementMasse object is equal to o.
   */
  @Override
