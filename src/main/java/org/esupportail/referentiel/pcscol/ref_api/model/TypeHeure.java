 ...
 */
@JsonPropertyOrder({
  TypeHeure.JSON_PROPERTY_PONDERATION_HETD
})
...
public class TypeHeure extends Nomenclature {
  public static final String JSON_PROPERTY_PONDERATION_HETD = "ponderationHetd";
  private Float ponderationHetd;

  public TypeHeure() { 
  }

  public TypeHeure ponderationHetd(Float ponderationHetd) {
    this.ponderationHetd = ponderationHetd;
    return this;
  }

  /**
   * heure équivalent TD
   * @return ponderationHetd
   */
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_PONDERATION_HETD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public Float getPonderationHetd() {
    return ponderationHetd;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PONDERATION_HETD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPonderationHetd(Float ponderationHetd) {
    this.ponderationHetd = ponderationHetd;
  }


  @Override
  public TypeHeure code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public TypeHeure libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public TypeHeure libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public TypeHeure libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public TypeHeure prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public TypeHeure dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public TypeHeure dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public TypeHeure temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public TypeHeure temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this TypeHeure object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TypeHeure typeHeure = (TypeHeure) o;
    return Objects.equals(this.ponderationHetd, typeHeure.ponderationHetd) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ponderationHetd, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TypeHeure {\n");
    sb.append("    ").append(toIndentedString(super.toString())).append("\n");
    sb.append("    ponderationHetd: ").append(toIndentedString(ponderationHetd)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `ponderationHetd` to the URL query string
    if (getPonderationHetd() != null) {
      joiner.add(String.format("%sponderationHetd%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getPonderationHetd()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
...
static {
  ...
  JSON.registerDiscriminator(TypeHeure.class, "typeNomenclature", mappings);
}
}
