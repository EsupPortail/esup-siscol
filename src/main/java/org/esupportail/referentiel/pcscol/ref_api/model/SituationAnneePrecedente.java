...
public class SituationAnneePrecedente extends Nomenclature {
  ...
  public SituationAnneePrecedente codeBcn(String codeBcn) {
  ...
  @Override
  public SituationAnneePrecedente libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public SituationAnneePrecedente libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public SituationAnneePrecedente libelleAffichage(String libelleAffichage) {
  ...
  @Override
  public SituationAnneePrecedente dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public SituationAnneePrecedente dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public SituationAnneePrecedente temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public SituationAnneePrecedente temoinLivre(Boolean temoinLivre) {
