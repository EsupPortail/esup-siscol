 ...
 */
@JsonPropertyOrder({
  GradePointAverage.JSON_PROPERTY_VALEUR
})
...
public class GradePointAverage extends Nomenclature {
  ...
  public GradePointAverage valeur(Double valeur) {
    this.valeur = valeur;
    return this;
  }
  ...
  @Override
  public GradePointAverage code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public GradePointAverage libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public GradePointAverage libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public GradePointAverage libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public GradePointAverage prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public GradePointAverage dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public GradePointAverage dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public GradePointAverage temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public GradePointAverage temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this GradePointAverage object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GradePointAverage gradePointAverage = (GradePointAverage) o;
    return Objects.equals(this.valeur, gradePointAverage.valeur) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class GradePointAverage {\n");
...
static {
  ...
  JSON.registerDiscriminator(GradePointAverage.class, "typeNomenclature", mappings);
}
}
