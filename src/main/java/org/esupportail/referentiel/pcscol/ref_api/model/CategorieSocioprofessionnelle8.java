 ...
 */
@JsonPropertyOrder({
  CategorieSocioprofessionnelle8.JSON_PROPERTY_TYPE_NOMENCLATURE,
  CategorieSocioprofessionnelle8.JSON_PROPERTY_CODE_BCN
})
...
public class CategorieSocioprofessionnelle8 extends Nomenclature {
  ...
  public CategorieSocioprofessionnelle8() { 
  }

  public CategorieSocioprofessionnelle8 typeNomenclature(String typeNomenclature) {
  ...
  public CategorieSocioprofessionnelle8 codeBcn(String codeBcn) {
  ...
  @Override
  public CategorieSocioprofessionnelle8 code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public CategorieSocioprofessionnelle8 libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public CategorieSocioprofessionnelle8 libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public CategorieSocioprofessionnelle8 libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public CategorieSocioprofessionnelle8 prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public CategorieSocioprofessionnelle8 dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public CategorieSocioprofessionnelle8 dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public CategorieSocioprofessionnelle8 temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public CategorieSocioprofessionnelle8 temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this CategorieSocioprofessionnelle8 object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CategorieSocioprofessionnelle8 categorieSocioprofessionnelle8 = (CategorieSocioprofessionnelle8) o;
    return Objects.equals(this.typeNomenclature, categorieSocioprofessionnelle8.typeNomenclature) &&
        Objects.equals(this.codeBcn, categorieSocioprofessionnelle8.codeBcn) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(typeNomenclature, codeBcn, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CategorieSocioprofessionnelle8 {\n");
...
static {
  ...
  JSON.registerDiscriminator(CategorieSocioprofessionnelle8.class, "typeNomenclature", mappings);
}
}
