...
/**
 * Nomenclature des niveaux de diplôme. Cette nomenclature est utilisée dans l&#39;offre de formation pour qualifier une formation diplômante.
 */
@JsonPropertyOrder({
  NiveauDiplome.JSON_PROPERTY_CODE_BCN
})
...
public class NiveauDiplome extends Nomenclature {
  ...
  public NiveauDiplome codeBcn(String codeBcn) {
  ...
  @Override
  public NiveauDiplome code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public NiveauDiplome libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public NiveauDiplome libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public NiveauDiplome libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public NiveauDiplome prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public NiveauDiplome dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public NiveauDiplome dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public NiveauDiplome temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public NiveauDiplome temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this NiveauDiplome object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    NiveauDiplome niveauDiplome = (NiveauDiplome) o;
    return Objects.equals(this.codeBcn, niveauDiplome.codeBcn) &&
        super.equals(o);
  }
...
static {
  ...
  JSON.registerDiscriminator(NiveauDiplome.class, "typeNomenclature", mappings);
}
}
