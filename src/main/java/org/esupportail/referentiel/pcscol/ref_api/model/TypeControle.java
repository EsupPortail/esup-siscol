...
public class TypeControle extends Nomenclature {
  public TypeControle() { 
  }
  ...
  @Override
  public TypeControle prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public TypeControle dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public TypeControle dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public TypeControle temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public TypeControle temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this TypeControle object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(TypeControle.class, "typeNomenclature", mappings);
}
}
