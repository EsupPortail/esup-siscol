...
/**
 * Nomenclature des titres d&#39;accès
 */
@JsonPropertyOrder({
  TitreAcces.JSON_PROPERTY_TYPE_NOMENCLATURE
})
...
public class TitreAcces extends Nomenclature {
  ...
  public TitreAcces typeNomenclature(String typeNomenclature) {
  ...
  @Override
  public TitreAcces code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public TitreAcces libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public TitreAcces libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public TitreAcces libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public TitreAcces prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public TitreAcces dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public TitreAcces dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public TitreAcces temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public TitreAcces temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this TitreAcces object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TitreAcces titreAcces = (TitreAcces) o;
    return Objects.equals(this.typeNomenclature, titreAcces.typeNomenclature) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(typeNomenclature, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TitreAcces {\n");
...
static {
  ...
  JSON.registerDiscriminator(TitreAcces.class, "typeNomenclature", mappings);
}
}
