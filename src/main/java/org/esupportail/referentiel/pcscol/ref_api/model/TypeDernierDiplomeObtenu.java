 ...
 */
@JsonPropertyOrder({
  TypeDernierDiplomeObtenu.JSON_PROPERTY_CODE_BCN
})
...
public class TypeDernierDiplomeObtenu extends Nomenclature {
  public static final String JSON_PROPERTY_CODE_BCN = "codeBcn";
  private String codeBcn;

  public TypeDernierDiplomeObtenu() { 
  }

  public TypeDernierDiplomeObtenu codeBcn(String codeBcn) {
    this.codeBcn = codeBcn;
    return this;
  }

  /**
   * un code  de l&#39;occurennce dans la base BCN
   * @return codeBcn
   */
  ...
  @Override
  public TypeDernierDiplomeObtenu code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public TypeDernierDiplomeObtenu libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public TypeDernierDiplomeObtenu libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public TypeDernierDiplomeObtenu libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public TypeDernierDiplomeObtenu prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public TypeDernierDiplomeObtenu dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public TypeDernierDiplomeObtenu dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public TypeDernierDiplomeObtenu temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public TypeDernierDiplomeObtenu temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this TypeDernierDiplomeObtenu object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TypeDernierDiplomeObtenu typeDernierDiplomeObtenu = (TypeDernierDiplomeObtenu) o;
    return Objects.equals(this.codeBcn, typeDernierDiplomeObtenu.codeBcn) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class TypeDernierDiplomeObtenu {\n");
...
static {
  ...
  JSON.registerDiscriminator(TypeDernierDiplomeObtenu.class, "typeNomenclature", mappings);
}
}
