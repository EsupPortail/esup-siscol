...
/**
 * Paramétrage des champs de formation
 */
@JsonPropertyOrder({
})
...
public class ChampsFormation extends Nomenclature {
  public ChampsFormation() { 
  }

  @Override
  public ChampsFormation code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public ChampsFormation libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public ChampsFormation libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public ChampsFormation libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public ChampsFormation prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public ChampsFormation dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public ChampsFormation dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public ChampsFormation temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public ChampsFormation temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this ChampsFormation object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class ChampsFormation {\n");
...
static {
  ...
  JSON.registerDiscriminator(ChampsFormation.class, "typeNomenclature", mappings);
}
}
