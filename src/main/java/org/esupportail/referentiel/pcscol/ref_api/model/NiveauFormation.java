...
/**
 * Nomenclature descriptive des formations et diplômes limitée à l&#39;enseignement supérieur. Spécifique du système SISE.
 */
@JsonPropertyOrder({
  NiveauFormation.JSON_PROPERTY_TYPE_NOMENCLATURE,
  NiveauFormation.JSON_PROPERTY_CODE_BCN
})
...
public class NiveauFormation extends Nomenclature {
  ...
  public NiveauFormation typeNomenclature(String typeNomenclature) {
  ...
  public NiveauFormation codeBcn(String codeBcn) {
  ...
  @Override
  public NiveauFormation code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public NiveauFormation libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public NiveauFormation libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public NiveauFormation libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public NiveauFormation prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public NiveauFormation dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public NiveauFormation dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public NiveauFormation temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public NiveauFormation temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this NiveauFormation object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.typeNomenclature, niveauFormation.typeNomenclature) &&
        Objects.equals(this.codeBcn, niveauFormation.codeBcn) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class NiveauFormation {\n");
...
static {
  ...
  JSON.registerDiscriminator(NiveauFormation.class, "typeNomenclature", mappings);
}
}
