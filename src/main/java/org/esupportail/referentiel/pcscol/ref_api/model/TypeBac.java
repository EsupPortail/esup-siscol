...
/**
 * Nomenclature des types BAC
 */
@JsonPropertyOrder({
  TypeBac.JSON_PROPERTY_TYPE_NOMENCLATURE
})
...
public class TypeBac extends Nomenclature {
  ...
  public TypeBac typeNomenclature(String typeNomenclature) {
  ...
  @Override
  public TypeBac code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public TypeBac libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public TypeBac libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public TypeBac libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public TypeBac prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public TypeBac dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public TypeBac dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public TypeBac temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public TypeBac temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this TypeBac object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TypeBac typeBac = (TypeBac) o;
    return Objects.equals(this.typeNomenclature, typeBac.typeNomenclature) &&
        super.equals(o);
  }
...
static {
  ...
  JSON.registerDiscriminator(TypeBac.class, "typeNomenclature", mappings);
}
}
