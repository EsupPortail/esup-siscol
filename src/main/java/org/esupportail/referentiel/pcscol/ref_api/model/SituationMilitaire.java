...
/**
 * Nomenclature des situations militaires possibles
 */
@JsonPropertyOrder({
  SituationMilitaire.JSON_PROPERTY_CODE_BCN
})
...
public class SituationMilitaire extends Nomenclature {
  ...
  public SituationMilitaire codeBcn(String codeBcn) {
    this.codeBcn = codeBcn;
    return this;
  }

  /**
   * Le code BCN de la valeur
   * @return codeBcn
   */
  ...
  @Override
  public SituationMilitaire code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public SituationMilitaire libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public SituationMilitaire libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public SituationMilitaire libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public SituationMilitaire prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public SituationMilitaire dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public SituationMilitaire dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public SituationMilitaire temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public SituationMilitaire temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this SituationMilitaire object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SituationMilitaire situationMilitaire = (SituationMilitaire) o;
    return Objects.equals(this.codeBcn, situationMilitaire.codeBcn) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class SituationMilitaire {\n");
...
static {
  ...
  JSON.registerDiscriminator(SituationMilitaire.class, "typeNomenclature", mappings);
}
}
