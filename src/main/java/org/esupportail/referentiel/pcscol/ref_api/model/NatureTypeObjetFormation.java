 ...
 */
@JsonPropertyOrder({
  NatureTypeObjetFormation.JSON_PROPERTY_TYPE_OBJET_FORMATION
})
...
public class NatureTypeObjetFormation extends Nomenclature {
  ...
  public NatureTypeObjetFormation() { 
  }

  public NatureTypeObjetFormation typeObjetFormation(TypeObjetFormation typeObjetFormation) {
  ...
  @JsonProperty(JSON_PROPERTY_TYPE_OBJET_FORMATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTypeObjetFormation(TypeObjetFormation typeObjetFormation) {
    this.typeObjetFormation = typeObjetFormation;
  }


  @Override
  public NatureTypeObjetFormation code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public NatureTypeObjetFormation libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public NatureTypeObjetFormation libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public NatureTypeObjetFormation libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public NatureTypeObjetFormation prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public NatureTypeObjetFormation dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public NatureTypeObjetFormation dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public NatureTypeObjetFormation temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public NatureTypeObjetFormation temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this NatureTypeObjetFormation object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    NatureTypeObjetFormation natureTypeObjetFormation = (NatureTypeObjetFormation) o;
    return Objects.equals(this.typeObjetFormation, natureTypeObjetFormation.typeObjetFormation) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(typeObjetFormation, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NatureTypeObjetFormation {\n");
...
static {
  ...
  JSON.registerDiscriminator(NatureTypeObjetFormation.class, "typeNomenclature", mappings);
}
}
