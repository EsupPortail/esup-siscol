...
public class ModaliteEnseignement extends Nomenclature {
  public ModaliteEnseignement() { 
  }

  @Override
  public ModaliteEnseignement code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public ModaliteEnseignement libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public ModaliteEnseignement libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public ModaliteEnseignement libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public ModaliteEnseignement prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public ModaliteEnseignement dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public ModaliteEnseignement dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public ModaliteEnseignement temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public ModaliteEnseignement temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this ModaliteEnseignement object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class ModaliteEnseignement {\n");
...
static {
  ...
  JSON.registerDiscriminator(ModaliteEnseignement.class, "typeNomenclature", mappings);
}
}
