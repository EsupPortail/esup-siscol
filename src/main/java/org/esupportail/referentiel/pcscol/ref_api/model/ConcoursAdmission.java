...
/**
 * Paramétrage des concours sur lesquels l&#39;établissement recrute
 */
@JsonPropertyOrder({
})
...
public class ConcoursAdmission extends Nomenclature {
  public ConcoursAdmission() { 
  }

  @Override
  public ConcoursAdmission code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public ConcoursAdmission libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public ConcoursAdmission libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public ConcoursAdmission libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public ConcoursAdmission prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public ConcoursAdmission dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public ConcoursAdmission dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public ConcoursAdmission temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public ConcoursAdmission temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this ConcoursAdmission object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class ConcoursAdmission {\n");
...
static {
  ...
  JSON.registerDiscriminator(ConcoursAdmission.class, "typeNomenclature", mappings);
}
}
