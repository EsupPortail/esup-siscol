...
/**
 * Nomenclature des situations d&#39;emploi
 */
@JsonPropertyOrder({
  SituationEmploi.JSON_PROPERTY_TYPE_NOMENCLATURE,
  SituationEmploi.JSON_PROPERTY_CODE_BCN
})
...
public class SituationEmploi extends Nomenclature {
  ...
  public SituationEmploi() { 
  }

  public SituationEmploi typeNomenclature(String typeNomenclature) {
  ...
  public SituationEmploi codeBcn(String codeBcn) {
  ...
  @Override
  public SituationEmploi code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public SituationEmploi libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public SituationEmploi libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public SituationEmploi libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public SituationEmploi prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public SituationEmploi dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public SituationEmploi dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public SituationEmploi temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public SituationEmploi temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this SituationEmploi object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SituationEmploi situationEmploi = (SituationEmploi) o;
    return Objects.equals(this.typeNomenclature, situationEmploi.typeNomenclature) &&
        Objects.equals(this.codeBcn, situationEmploi.codeBcn) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class SituationEmploi {\n");
...
static {
  ...
  JSON.registerDiscriminator(SituationEmploi.class, "typeNomenclature", mappings);
}
}
