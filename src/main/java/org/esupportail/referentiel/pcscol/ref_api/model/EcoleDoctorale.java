...
/**
 * Nomenclature des Ecoles doctorales
 */
@JsonPropertyOrder({
  EcoleDoctorale.JSON_PROPERTY_TYPE_NOMENCLATURE,
  EcoleDoctorale.JSON_PROPERTY_ETABLISSEMENT_SUPPORT,
  EcoleDoctorale.JSON_PROPERTY_UAI
})
...
public class EcoleDoctorale extends Nomenclature {
  public static final String JSON_PROPERTY_TYPE_NOMENCLATURE = "typeNomenclature";
  private String typeNomenclature;

  public static final String JSON_PROPERTY_ETABLISSEMENT_SUPPORT = "etablissementSupport";
  private String etablissementSupport;
  ...
  public EcoleDoctorale typeNomenclature(String typeNomenclature) {
  ...
  public EcoleDoctorale etablissementSupport(String etablissementSupport) {
    this.etablissementSupport = etablissementSupport;
    return this;
  }

  /**
   * Etablissement de rattachement de l&#39;école doctorale
   * @return etablissementSupport
   */
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_ETABLISSEMENT_SUPPORT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public String getEtablissementSupport() {
    return etablissementSupport;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ETABLISSEMENT_SUPPORT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setEtablissementSupport(String etablissementSupport) {
    this.etablissementSupport = etablissementSupport;
  }


  public EcoleDoctorale uai(String uai) {
    this.uai = uai;
    return this;
  }
  ...
  @Override
  public EcoleDoctorale libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public EcoleDoctorale libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public EcoleDoctorale libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public EcoleDoctorale prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public EcoleDoctorale dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public EcoleDoctorale dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public EcoleDoctorale temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public EcoleDoctorale temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this EcoleDoctorale object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.typeNomenclature, ecoleDoctorale.typeNomenclature) &&
        Objects.equals(this.etablissementSupport, ecoleDoctorale.etablissementSupport) &&
        Objects.equals(this.uai, ecoleDoctorale.uai) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(typeNomenclature, etablissementSupport, uai, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("    etablissementSupport: ").append(toIndentedString(etablissementSupport)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `etablissementSupport` to the URL query string
    if (getEtablissementSupport() != null) {
      joiner.add(String.format("%setablissementSupport%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getEtablissementSupport()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
...
static {
  ...
  JSON.registerDiscriminator(EcoleDoctorale.class, "typeNomenclature", mappings);
}
}
