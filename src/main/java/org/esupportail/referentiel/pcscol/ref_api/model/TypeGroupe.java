...
public class TypeGroupe extends Nomenclature {
  public TypeGroupe() { 
  }

  @Override
  public TypeGroupe code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public TypeGroupe libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public TypeGroupe libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public TypeGroupe libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public TypeGroupe prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public TypeGroupe dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public TypeGroupe dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public TypeGroupe temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public TypeGroupe temoinLivre(Boolean temoinLivre) {
...
static {
  ...
  JSON.registerDiscriminator(TypeGroupe.class, "typeNomenclature", mappings);
}
}
