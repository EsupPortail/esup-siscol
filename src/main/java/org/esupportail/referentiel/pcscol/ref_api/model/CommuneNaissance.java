...
/**
 * Nomenclature des communes de naissance
 */
@JsonPropertyOrder({
  CommuneNaissance.JSON_PROPERTY_TYPE_NOMENCLATURE,
  CommuneNaissance.JSON_PROPERTY_DEPARTEMENT
})
...
public class CommuneNaissance extends Nomenclature {
  ...
  public CommuneNaissance typeNomenclature(String typeNomenclature) {
  ...
  public CommuneNaissance departement(String departement) {
  ...
  @Override
  public CommuneNaissance code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public CommuneNaissance libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public CommuneNaissance libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public CommuneNaissance libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public CommuneNaissance prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public CommuneNaissance dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public CommuneNaissance dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public CommuneNaissance temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public CommuneNaissance temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this CommuneNaissance object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CommuneNaissance communeNaissance = (CommuneNaissance) o;
    return Objects.equals(this.typeNomenclature, communeNaissance.typeNomenclature) &&
        Objects.equals(this.departement, communeNaissance.departement) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(typeNomenclature, departement, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CommuneNaissance {\n");
...
static {
  ...
  JSON.registerDiscriminator(CommuneNaissance.class, "typeNomenclature", mappings);
}
}
