...
/**
 * Nomenclature des régimes spéciaux d&#39;études
 */
@JsonPropertyOrder({
})
...
public class RegimeSpecialEtudes extends Nomenclature {
  public RegimeSpecialEtudes() { 
  }

  @Override
  public RegimeSpecialEtudes code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public RegimeSpecialEtudes libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public RegimeSpecialEtudes libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public RegimeSpecialEtudes libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public RegimeSpecialEtudes prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public RegimeSpecialEtudes dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public RegimeSpecialEtudes dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public RegimeSpecialEtudes temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public RegimeSpecialEtudes temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this RegimeSpecialEtudes object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class RegimeSpecialEtudes {\n");
...
static {
  ...
  JSON.registerDiscriminator(RegimeSpecialEtudes.class, "typeNomenclature", mappings);
}
}
