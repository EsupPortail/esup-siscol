...
/**
 * Nomenclature des situations familiales possibles
 */
@JsonPropertyOrder({
  SituationFamiliale.JSON_PROPERTY_CODE_BCN
})
...
public class SituationFamiliale extends Nomenclature {
  ...
  public SituationFamiliale codeBcn(String codeBcn) {
  ...
  @Override
  public SituationFamiliale libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public SituationFamiliale libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public SituationFamiliale libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public SituationFamiliale prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public SituationFamiliale dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public SituationFamiliale dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public SituationFamiliale temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public SituationFamiliale temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this SituationFamiliale object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.codeBcn, situationFamiliale.codeBcn) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class SituationFamiliale {\n");
...
static {
  ...
  JSON.registerDiscriminator(SituationFamiliale.class, "typeNomenclature", mappings);
}
}
