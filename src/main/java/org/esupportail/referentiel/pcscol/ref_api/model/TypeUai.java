...
/**
 * Nomenclature des types UAI
 */
@JsonPropertyOrder({
  TypeUai.JSON_PROPERTY_TYPE_NOMENCLATURE,
  TypeUai.JSON_PROPERTY_TYPE_UAI,
  TypeUai.JSON_PROPERTY_TYPE_UAI_LIBE
})
...
public class TypeUai extends Nomenclature {
  ...
  public static final String JSON_PROPERTY_TYPE_UAI_LIBE = "typeUaiLibe";
  private String typeUaiLibe;

  public TypeUai() { 
  }

  public TypeUai typeNomenclature(String typeNomenclature) {
  ...
  public TypeUai typeUai(String typeUai) {
  ...
  @JsonProperty(JSON_PROPERTY_TYPE_UAI)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTypeUai(String typeUai) {
    this.typeUai = typeUai;
  }


  public TypeUai typeUaiLibe(String typeUaiLibe) {
    this.typeUaiLibe = typeUaiLibe;
    return this;
  }

  /**
   * Le libellé du type de l&#39;UAI
   * @return typeUaiLibe
   */
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_TYPE_UAI_LIBE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public String getTypeUaiLibe() {
    return typeUaiLibe;
  }
  ...
  @JsonProperty(JSON_PROPERTY_TYPE_UAI_LIBE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTypeUaiLibe(String typeUaiLibe) {
    this.typeUaiLibe = typeUaiLibe;
  }


  @Override
  public TypeUai code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public TypeUai libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public TypeUai libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public TypeUai libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public TypeUai prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public TypeUai dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public TypeUai dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public TypeUai temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public TypeUai temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this TypeUai object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TypeUai typeUai = (TypeUai) o;
    return Objects.equals(this.typeNomenclature, typeUai.typeNomenclature) &&
        Objects.equals(this.typeUai, typeUai.typeUai) &&
        Objects.equals(this.typeUaiLibe, typeUai.typeUaiLibe) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(typeNomenclature, typeUai, typeUaiLibe, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TypeUai {\n");
    ...
    sb.append("    typeUaiLibe: ").append(toIndentedString(typeUaiLibe)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getTypeUai() != null) {
      joiner.add(String.format("%stypeUai%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getTypeUai()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `typeUaiLibe` to the URL query string
    if (getTypeUaiLibe() != null) {
      joiner.add(String.format("%stypeUaiLibe%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getTypeUaiLibe()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
...
static {
  ...
  JSON.registerDiscriminator(TypeUai.class, "typeNomenclature", mappings);
}
}
