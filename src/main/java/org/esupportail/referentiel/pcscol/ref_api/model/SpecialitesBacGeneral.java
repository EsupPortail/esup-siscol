...
/**
 * Nomenclature des spécialités du bac général
 */
@JsonPropertyOrder({
  SpecialitesBacGeneral.JSON_PROPERTY_CODE_BCN
})
...
public class SpecialitesBacGeneral extends Nomenclature {
  ...
  public SpecialitesBacGeneral codeBcn(String codeBcn) {
  ...
  @Override
  public SpecialitesBacGeneral code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public SpecialitesBacGeneral libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public SpecialitesBacGeneral libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public SpecialitesBacGeneral libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public SpecialitesBacGeneral prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public SpecialitesBacGeneral dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public SpecialitesBacGeneral dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public SpecialitesBacGeneral temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public SpecialitesBacGeneral temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this SpecialitesBacGeneral object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SpecialitesBacGeneral specialitesBacGeneral = (SpecialitesBacGeneral) o;
    return Objects.equals(this.codeBcn, specialitesBacGeneral.codeBcn) &&
        super.equals(o);
  }
...
static {
  ...
  JSON.registerDiscriminator(SpecialitesBacGeneral.class, "typeNomenclature", mappings);
}
}
