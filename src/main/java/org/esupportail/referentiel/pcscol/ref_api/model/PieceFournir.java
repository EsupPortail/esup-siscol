...
/**
 * Paramétrage des documents pouvant être demandés dans le cadre de la candidature ou de l&#39;’inscription
 */
@JsonPropertyOrder({
})
...
public class PieceFournir extends Nomenclature {
  public PieceFournir() { 
  }

  @Override
  public PieceFournir code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public PieceFournir libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public PieceFournir libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public PieceFournir libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public PieceFournir prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public PieceFournir dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public PieceFournir dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public PieceFournir temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public PieceFournir temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this PieceFournir object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(PieceFournir.class, "typeNomenclature", mappings);
}
}
