...
public class CategorieJuridique extends Nomenclature {
  public CategorieJuridique() { 
  }

  @Override
  public CategorieJuridique typeNomenclature(String typeNomenclature) {
    this.setTypeNomenclature(typeNomenclature);
    return this;
  }

  @Override
  public CategorieJuridique code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public CategorieJuridique libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public CategorieJuridique libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public CategorieJuridique libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public CategorieJuridique prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public CategorieJuridique dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public CategorieJuridique dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public CategorieJuridique temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public CategorieJuridique temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this CategorieJuridique object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class CategorieJuridique {\n");
...
static {
  ...
  JSON.registerDiscriminator(CategorieJuridique.class, "typeNomenclature", mappings);
}
}
