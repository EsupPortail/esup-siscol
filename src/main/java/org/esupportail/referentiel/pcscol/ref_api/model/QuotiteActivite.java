...
/**
 * Nomenclature des quotités travaillées
 */
@JsonPropertyOrder({
  QuotiteActivite.JSON_PROPERTY_CODE_BCN
})
...
public class QuotiteActivite extends Nomenclature {
  public static final String JSON_PROPERTY_CODE_BCN = "codeBcn";
  private String codeBcn;

  public QuotiteActivite() { 
  }

  public QuotiteActivite codeBcn(String codeBcn) {
  ...
  @Override
  public QuotiteActivite code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public QuotiteActivite libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public QuotiteActivite libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public QuotiteActivite libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public QuotiteActivite prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public QuotiteActivite dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public QuotiteActivite dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public QuotiteActivite temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public QuotiteActivite temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this QuotiteActivite object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    QuotiteActivite quotiteActivite = (QuotiteActivite) o;
    return Objects.equals(this.codeBcn, quotiteActivite.codeBcn) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class QuotiteActivite {\n");
...
static {
  ...
  JSON.registerDiscriminator(QuotiteActivite.class, "typeNomenclature", mappings);
}
}
