...
/**
 * Nomenclature des Degré de reconnaissance du diplôme :diplôme national, diplôme d&#39;université homologué ou non, préparation aux concours, ....
 */
@JsonPropertyOrder({
  NatureDiplome.JSON_PROPERTY_TYPE_NOMENCLATURE,
  NatureDiplome.JSON_PROPERTY_CODE_BCN
})
...
public class NatureDiplome extends Nomenclature {
  ...
  public NatureDiplome typeNomenclature(String typeNomenclature) {
  ...
  public NatureDiplome codeBcn(String codeBcn) {
  ...
  @Override
  public NatureDiplome code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public NatureDiplome libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public NatureDiplome libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public NatureDiplome libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public NatureDiplome prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public NatureDiplome dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public NatureDiplome dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public NatureDiplome temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public NatureDiplome temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this NatureDiplome object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    NatureDiplome natureDiplome = (NatureDiplome) o;
    return Objects.equals(this.typeNomenclature, natureDiplome.typeNomenclature) &&
        Objects.equals(this.codeBcn, natureDiplome.codeBcn) &&
        super.equals(o);
  }
...
static {
  ...
  JSON.registerDiscriminator(NatureDiplome.class, "typeNomenclature", mappings);
}
}
