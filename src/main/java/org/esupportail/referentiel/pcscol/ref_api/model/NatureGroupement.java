...
public class NatureGroupement extends Nomenclature {
  public NatureGroupement() { 
  }

  @Override
  public NatureGroupement code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public NatureGroupement libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public NatureGroupement libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public NatureGroupement libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public NatureGroupement prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public NatureGroupement dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public NatureGroupement dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public NatureGroupement temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public NatureGroupement temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this NatureGroupement object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class NatureGroupement {\n");
...
static {
  ...
  JSON.registerDiscriminator(NatureGroupement.class, "typeNomenclature", mappings);
}
}
