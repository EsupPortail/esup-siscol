...
/**
 * Nomenclature des cursus de formation. Cette nomenclature est utilisée dans l&#39;offre de formation pour qualifier une formation
 */
@JsonPropertyOrder({
  CursusFormation.JSON_PROPERTY_TYPE_NOMENCLATURE,
  CursusFormation.JSON_PROPERTY_CODE_BCN
})
...
public class CursusFormation extends Nomenclature {
  ...
  public CursusFormation typeNomenclature(String typeNomenclature) {
  ...
  public CursusFormation codeBcn(String codeBcn) {
  ...
  @Override
  public CursusFormation code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public CursusFormation libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public CursusFormation libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public CursusFormation libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public CursusFormation prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public CursusFormation dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public CursusFormation dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public CursusFormation temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public CursusFormation temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this CursusFormation object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CursusFormation cursusFormation = (CursusFormation) o;
    return Objects.equals(this.typeNomenclature, cursusFormation.typeNomenclature) &&
        Objects.equals(this.codeBcn, cursusFormation.codeBcn) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class CursusFormation {\n");
...
static {
  ...
  JSON.registerDiscriminator(CursusFormation.class, "typeNomenclature", mappings);
}
}
