...
public class MentionHonorifique extends Nomenclature {
  ...
  @Override
  public MentionHonorifique prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public MentionHonorifique dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public MentionHonorifique dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public MentionHonorifique temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public MentionHonorifique temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this MentionHonorifique object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(MentionHonorifique.class, "typeNomenclature", mappings);
}
}
