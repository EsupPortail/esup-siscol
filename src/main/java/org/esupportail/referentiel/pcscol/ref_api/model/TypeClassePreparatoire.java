...
/**
 * Nomenclature des types de classes de préparatoires
 */
@JsonPropertyOrder({
  TypeClassePreparatoire.JSON_PROPERTY_CODE_BCN
})
...
public class TypeClassePreparatoire extends Nomenclature {
  public static final String JSON_PROPERTY_CODE_BCN = "codeBcn";
  private String codeBcn;

  public TypeClassePreparatoire() { 
  }

  public TypeClassePreparatoire codeBcn(String codeBcn) {
    this.codeBcn = codeBcn;
    return this;
  }

  /**
   * Un code unique de l&#39;occurennce dans la base BCN
   * @return codeBcn
   */
  ...
  @Override
  public TypeClassePreparatoire code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public TypeClassePreparatoire libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public TypeClassePreparatoire libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public TypeClassePreparatoire libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public TypeClassePreparatoire prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public TypeClassePreparatoire dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public TypeClassePreparatoire dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public TypeClassePreparatoire temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public TypeClassePreparatoire temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this TypeClassePreparatoire object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TypeClassePreparatoire typeClassePreparatoire = (TypeClassePreparatoire) o;
    return Objects.equals(this.codeBcn, typeClassePreparatoire.codeBcn) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class TypeClassePreparatoire {\n");
...
static {
  ...
  JSON.registerDiscriminator(TypeClassePreparatoire.class, "typeNomenclature", mappings);
}
}
