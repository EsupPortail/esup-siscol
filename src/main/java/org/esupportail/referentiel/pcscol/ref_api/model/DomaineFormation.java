...
/**
 * Nomenclature des domaines des diplômes de l&#39;enseignement supérieur répartis selon leurs disciplines
 */
@JsonPropertyOrder({
  DomaineFormation.JSON_PROPERTY_TYPE_NOMENCLATURE,
  DomaineFormation.JSON_PROPERTY_CODE_BCN
})
...
public class DomaineFormation extends Nomenclature {
  ...
  public DomaineFormation typeNomenclature(String typeNomenclature) {
  ...
  public DomaineFormation codeBcn(String codeBcn) {
  ...
  @Override
  public DomaineFormation code(String code) {
    this.setCode(code);
    return this;
  }

  @Override
  public DomaineFormation libelleCourt(String libelleCourt) {
    this.setLibelleCourt(libelleCourt);
    return this;
  }

  @Override
  public DomaineFormation libelleLong(String libelleLong) {
    this.setLibelleLong(libelleLong);
    return this;
  }

  @Override
  public DomaineFormation libelleAffichage(String libelleAffichage) {
    this.setLibelleAffichage(libelleAffichage);
    return this;
  }

  @Override
  public DomaineFormation prioriteAffichage(Integer prioriteAffichage) {
    this.setPrioriteAffichage(prioriteAffichage);
    return this;
  }

  @Override
  public DomaineFormation dateDebutValidite(Date dateDebutValidite) {
    this.setDateDebutValidite(dateDebutValidite);
    return this;
  }

  @Override
  public DomaineFormation dateFinValidite(Date dateFinValidite) {
    this.setDateFinValidite(dateFinValidite);
    return this;
  }

  @Override
  public DomaineFormation temoinVisible(Boolean temoinVisible) {
    this.setTemoinVisible(temoinVisible);
    return this;
  }

  @Override
  public DomaineFormation temoinLivre(Boolean temoinLivre) {
    this.setTemoinLivre(temoinLivre);
    return this;
  }

  /**
   * Return true if this DomaineFormation object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DomaineFormation domaineFormation = (DomaineFormation) o;
    return Objects.equals(this.typeNomenclature, domaineFormation.typeNomenclature) &&
        Objects.equals(this.codeBcn, domaineFormation.codeBcn) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class DomaineFormation {\n");
...
static {
  ...
  JSON.registerDiscriminator(DomaineFormation.class, "typeNomenclature", mappings);
}
}
